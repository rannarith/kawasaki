...
$model_thumbnail_blobview = NULL; // Initialize page object first

class cmodel_thumbnail_blobview extends cmodel {
	...
	// Page object name
	var $PageObjName = 'model_thumbnail_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('model', 'x_thumbnail');
...
// Create page object
if (!isset($model_thumbnail_blobview)) $model_thumbnail_blobview = new cmodel_thumbnail_blobview();

// Page init
$model_thumbnail_blobview->Page_Init();

// Page main
$model_thumbnail_blobview->Page_Main();
?>
<?php
$model_thumbnail_blobview->Page_Terminate();
?>
