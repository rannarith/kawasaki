...
class cmodel_category extends cTable {
	...
	function __construct() {
		...
		// category_id
		$this->category_id = new cField('model_category', 'model_category', 'x_category_id', 'category_id', '`category_id`', '`category_id`', 3, -1, FALSE, '`category_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->category_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['category_id'] = &$this->category_id;

		// category_name
		$this->category_name = new cField('model_category', 'model_category', 'x_category_name', 'category_name', '`category_name`', '`category_name`', 200, -1, FALSE, '`category_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['category_name'] = &$this->category_name;

		// status
		$this->status = new cField('model_category', 'model_category', 'x_status', 'status', '`status`', '`status`', 16, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->status->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// c_order
		$this->c_order = new cField('model_category', 'model_category', 'x_c_order', 'c_order', '`c_order`', '`c_order`', 16, -1, FALSE, '`c_order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`model_category`";
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("model_categoryview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "model_categoryadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("model_categoryedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("model_categoryadd.php", $this->UrlParm($parm));
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["category_id"]; // category_id
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				$Doc->ExportCaption($this->c_order);
			} else {
				$Doc->ExportCaption($this->category_id);
				$Doc->ExportCaption($this->category_name);
				$Doc->ExportCaption($this->status);
