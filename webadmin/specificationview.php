...
// Page object
var specification_view = new ew_Page("specification_view");
specification_view.PageID = "view"; // Page ID
var EW_PAGE_ID = specification_view.PageID; // For backward compatibility

// Form object
var fspecificationview = new ew_Form("fspecificationview");
...
fspecificationview.ValidateRequired = true;
<?php } else { ?>
fspecificationview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fspecificationview.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $specification->TableCaption() ?>&nbsp;&nbsp;</span><?php $specification_view->ExportOptions->Render("body"); ?>
</p>
<p class="phpmaker">
<a href="<?php echo $specification_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($specification_view->AddUrl <> "") { ?>
<a href="<?php echo $specification_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($specification_view->EditUrl <> "") { ?>
<a href="<?php echo $specification_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($specification_view->DeleteUrl <> "") { ?>
<a href="<?php echo $specification_view->DeleteUrl ?>"><?php echo $Language->Phrase("ViewPageDeleteLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>
...
?>
<form name="fspecificationview" id="fspecificationview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="specification">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_specificationview" class="ewTable">
...
<?php if ($specification->model_id->Visible) { // model_id ?>
	<tr id="r_model_id"<?php echo $specification->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_specification_model_id"><?php echo $specification->model_id->FldCaption() ?></span></td>
...
<?php if ($specification->title->Visible) { // title ?>
	<tr id="r_title"<?php echo $specification->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_specification_title"><?php echo $specification->title->FldCaption() ?></span></td>
...
<?php if ($specification->s_order->Visible) { // s_order ?>
	<tr id="r_s_order"<?php echo $specification->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_specification_s_order"><?php echo $specification->s_order->FldCaption() ?></span></td>
...
<?php if ($specification->status->Visible) { // status ?>
	<tr id="r_status"<?php echo $specification->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_specification_status"><?php echo $specification->status->FldCaption() ?></span></td>
