...
$news_gallery_image_blobview = NULL; // Initialize page object first

class cnews_gallery_image_blobview extends cnews_gallery {
	...
	// Page object name
	var $PageObjName = 'news_gallery_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('news_gallery', 'x_image');

		// Show thumbnail
		$bShowThumbnail = (@$_GET["showthumbnail"] == "1");
		if (@$_GET["thumbnailwidth"] == "" && @$_GET["thumbnailheight"] == "") {
			$iThumbnailWidth = 250; // Set default width
...
// Create page object
if (!isset($news_gallery_image_blobview)) $news_gallery_image_blobview = new cnews_gallery_image_blobview();

// Page init
$news_gallery_image_blobview->Page_Init();

// Page main
$news_gallery_image_blobview->Page_Main();
?>
<?php
$news_gallery_image_blobview->Page_Terminate();
?>
