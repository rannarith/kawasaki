...
?>
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $news->TableCaption() ?></span></p>
...
?>
<form name="fnewsdelete" id="fnewsdelete" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<p>
...
<table cellspacing="0" id="tbl_newsdelete" class="ewTable ewTableSeparate">
...
?>
	<tr<?php echo $news->RowAttributes() ?>>
		<td<?php echo $news->news_id->CellAttributes() ?>><span id="el<?php echo $news_delete->RowCnt ?>_news_news_id" class="news_news_id">
<span<?php echo $news->news_id->ViewAttributes() ?>>
<?php echo $news->news_id->ListViewValue() ?></span>
</span></td>
		<td<?php echo $news->thumbnail->CellAttributes() ?>><span id="el<?php echo $news_delete->RowCnt ?>_news_thumbnail" class="news_thumbnail">
<span>
...
<?php } ?>
		...
		<td<?php echo $news->title->CellAttributes() ?>><span id="el<?php echo $news_delete->RowCnt ?>_news_title" class="news_title">
<span<?php echo $news->title->ViewAttributes() ?>>
<?php echo $news->title->ListViewValue() ?></span>
</span></td>
		<td<?php echo $news->youtube_url->CellAttributes() ?>><span id="el<?php echo $news_delete->RowCnt ?>_news_youtube_url" class="news_youtube_url">
<span<?php echo $news->youtube_url->ViewAttributes() ?>>
<?php echo $news->youtube_url->ListViewValue() ?></span>
</span></td>
		<td<?php echo $news->news_date->CellAttributes() ?>><span id="el<?php echo $news_delete->RowCnt ?>_news_news_date" class="news_news_date">
<span<?php echo $news->news_date->ViewAttributes() ?>>
<?php echo $news->news_date->ListViewValue() ?></span>
</span></td>
		<td<?php echo $news->status->CellAttributes() ?>><span id="el<?php echo $news_delete->RowCnt ?>_news_status" class="news_status">
