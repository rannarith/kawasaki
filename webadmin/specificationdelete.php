...
// Page object
var specification_delete = new ew_Page("specification_delete");
specification_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = specification_delete.PageID; // For backward compatibility

// Form object
var fspecificationdelete = new ew_Form("fspecificationdelete");
...
fspecificationdelete.ValidateRequired = true;
<?php } else { ?>
fspecificationdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fspecificationdelete.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($specification_delete->Recordset = $specification_delete->LoadRecordset())
	$specification_deleteTotalRecs = $specification_delete->Recordset->RecordCount(); // Get record count
if ($specification_deleteTotalRecs <= 0) { // No record found, exit
	if ($specification_delete->Recordset)
		$specification_delete->Recordset->Close();
	$specification_delete->Page_Terminate("specificationlist.php"); // Return to list
}
?>
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $specification->TableCaption() ?></span></p>
...
?>
<form name="fspecificationdelete" id="fspecificationdelete" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<p>
...
<table cellspacing="0" id="tbl_specificationdelete" class="ewTable ewTableSeparate">
...
?>
	<tr<?php echo $specification->RowAttributes() ?>>
		<td<?php echo $specification->spec_id->CellAttributes() ?>><span id="el<?php echo $specification_delete->RowCnt ?>_specification_spec_id" class="specification_spec_id">
<span<?php echo $specification->spec_id->ViewAttributes() ?>>
<?php echo $specification->spec_id->ListViewValue() ?></span>
</span></td>
		<td<?php echo $specification->model_id->CellAttributes() ?>><span id="el<?php echo $specification_delete->RowCnt ?>_specification_model_id" class="specification_model_id">
<span<?php echo $specification->model_id->ViewAttributes() ?>>
<?php echo $specification->model_id->ListViewValue() ?></span>
</span></td>
		<td<?php echo $specification->title->CellAttributes() ?>><span id="el<?php echo $specification_delete->RowCnt ?>_specification_title" class="specification_title">
<span<?php echo $specification->title->ViewAttributes() ?>>
<?php echo $specification->title->ListViewValue() ?></span>
</span></td>
		<td<?php echo $specification->s_order->CellAttributes() ?>><span id="el<?php echo $specification_delete->RowCnt ?>_specification_s_order" class="specification_s_order">
<span<?php echo $specification->s_order->ViewAttributes() ?>>
<?php echo $specification->s_order->ListViewValue() ?></span>
</span></td>
		<td<?php echo $specification->status->CellAttributes() ?>><span id="el<?php echo $specification_delete->RowCnt ?>_specification_status" class="specification_status">
