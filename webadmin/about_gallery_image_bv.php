...
$about_gallery_image_blobview = NULL; // Initialize page object first

class cabout_gallery_image_blobview extends cabout_gallery {
	...
	// Page object name
	var $PageObjName = 'about_gallery_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('about_gallery', 'x_image');
...
// Create page object
if (!isset($about_gallery_image_blobview)) $about_gallery_image_blobview = new cabout_gallery_image_blobview();

// Page init
$about_gallery_image_blobview->Page_Init();

// Page main
$about_gallery_image_blobview->Page_Main();
?>
<?php
$about_gallery_image_blobview->Page_Terminate();
?>
