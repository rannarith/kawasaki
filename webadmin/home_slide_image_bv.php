...
$home_slide_image_blobview = NULL; // Initialize page object first

class chome_slide_image_blobview extends chome_slide {
	...
	// Page object name
	var $PageObjName = 'home_slide_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('home_slide', 'x_image');
...
// Create page object
if (!isset($home_slide_image_blobview)) $home_slide_image_blobview = new chome_slide_image_blobview();

// Page init
$home_slide_image_blobview->Page_Init();

// Page main
$home_slide_image_blobview->Page_Main();
?>
<?php
$home_slide_image_blobview->Page_Terminate();
?>
