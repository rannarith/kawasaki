...
// Page object
var about_gallery_view = new ew_Page("about_gallery_view");
about_gallery_view.PageID = "view"; // Page ID
var EW_PAGE_ID = about_gallery_view.PageID; // For backward compatibility

// Form object
var fabout_galleryview = new ew_Form("fabout_galleryview");
...
fabout_galleryview.ValidateRequired = true;
<?php } else { ?>
fabout_galleryview.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $about_gallery->TableCaption() ?>&nbsp;&nbsp;</span><?php $about_gallery_view->ExportOptions->Render("body"); ?>
</p>
<p class="phpmaker">
<a href="<?php echo $about_gallery_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($about_gallery_view->AddUrl <> "") { ?>
<a href="<?php echo $about_gallery_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($about_gallery_view->EditUrl <> "") { ?>
<a href="<?php echo $about_gallery_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($about_gallery_view->DeleteUrl <> "") { ?>
<a href="<?php echo $about_gallery_view->DeleteUrl ?>"><?php echo $Language->Phrase("ViewPageDeleteLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>
...
?>
<form name="fabout_galleryview" id="fabout_galleryview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="about_gallery">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_about_galleryview" class="ewTable">
...
<?php if ($about_gallery->img_order->Visible) { // img_order ?>
	<tr id="r_img_order"<?php echo $about_gallery->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_about_gallery_img_order"><?php echo $about_gallery->img_order->FldCaption() ?></span></td>
...
<?php if ($about_gallery->status->Visible) { // status ?>
	<tr id="r_status"<?php echo $about_gallery->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_about_gallery_status"><?php echo $about_gallery->status->FldCaption() ?></span></td>
