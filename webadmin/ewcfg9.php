...
define("EW_PROJECT_NAME", "admin1", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{5CB4AA5B-9E5D-4D28-80A0-11AF7C90D6A1}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'ePaU7US8rm85fEdq', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/admin1.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'kawasaki2', TRUE);
