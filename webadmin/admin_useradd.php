		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "admin_userview.php")
...
// Page object
var admin_user_add = new ew_Page("admin_user_add");
admin_user_add.PageID = "add"; // Page ID
var EW_PAGE_ID = admin_user_add.PageID; // For backward compatibility

// Form object
var fadmin_useradd = new ew_Form("fadmin_useradd");

// Validate form
fadmin_useradd.Validate = function(fobj) {
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $admin_user->TableCaption() ?></span></p>
...
?>
<form name="fadmin_useradd" id="fadmin_useradd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="admin_user">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_admin_useradd" class="ewTable">
...
<input type="password" name="x_password" id="x_password" size="30" maxlength="50"<?php echo $admin_user->password->EditAttributes() ?>>
