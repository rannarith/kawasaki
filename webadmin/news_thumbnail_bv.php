...
$news_thumbnail_blobview = NULL; // Initialize page object first

class cnews_thumbnail_blobview extends cnews {
	...
	// Page object name
	var $PageObjName = 'news_thumbnail_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('news', 'x_thumbnail');
...
// Create page object
if (!isset($news_thumbnail_blobview)) $news_thumbnail_blobview = new cnews_thumbnail_blobview();

// Page init
$news_thumbnail_blobview->Page_Init();

// Page main
$news_thumbnail_blobview->Page_Main();
?>
<?php
$news_thumbnail_blobview->Page_Terminate();
?>
