...
class cmodel_category_add extends cmodel_category {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "model_categoryview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->category_name->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(category_name = '" . ew_AdjustSql($this->category_name->CurrentValue) . "')";
...
// Page object
var model_category_add = new ew_Page("model_category_add");
model_category_add.PageID = "add"; // Page ID
var EW_PAGE_ID = model_category_add.PageID; // For backward compatibility

// Form object
var fmodel_categoryadd = new ew_Form("fmodel_categoryadd");

// Validate form
fmodel_categoryadd.Validate = function(fobj) {
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $model_category->TableCaption() ?></span></p>
...
?>
<form name="fmodel_categoryadd" id="fmodel_categoryadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="model_category">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_model_categoryadd" class="ewTable">
