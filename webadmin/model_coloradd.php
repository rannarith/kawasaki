		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "model_colorview.php")
...
// Page object
var model_color_add = new ew_Page("model_color_add");
model_color_add.PageID = "add"; // Page ID
var EW_PAGE_ID = model_color_add.PageID; // For backward compatibility

// Form object
var fmodel_coloradd = new ew_Form("fmodel_coloradd");

// Validate form
fmodel_coloradd.Validate = function(fobj) {
...
fmodel_coloradd.ValidateRequired = true;
<?php } else { ?>
fmodel_coloradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmodel_coloradd.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $model_color->TableCaption() ?></span></p>
...
?>
<form name="fmodel_coloradd" id="fmodel_coloradd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="model_color">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_model_coloradd" class="ewTable">
...
<script type="text/javascript">
fmodel_coloradd.Lists["x_model_id"].Options = <?php echo (is_array($model_color->model_id->EditValue)) ? ew_ArrayToJson($model_color->model_id->EditValue, 1) : "[]" ?>;
</script>
<?php } ?>
