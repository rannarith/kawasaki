...
$accessory_thumbnail_blobview = NULL; // Initialize page object first

class caccessory_thumbnail_blobview extends caccessory {
	...
	// Page object name
	var $PageObjName = 'accessory_thumbnail_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('accessory', 'x_thumbnail');
...
// Create page object
if (!isset($accessory_thumbnail_blobview)) $accessory_thumbnail_blobview = new caccessory_thumbnail_blobview();

// Page init
$accessory_thumbnail_blobview->Page_Init();

// Page main
$accessory_thumbnail_blobview->Page_Main();
?>
<?php
$accessory_thumbnail_blobview->Page_Terminate();
?>
