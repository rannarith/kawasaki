...
<table border="0" cellspacing="0" cellpadding="4">
	...
	<tr>
		...
		<label><input type="radio" name="contenttype" value="html" checked="checked"><?php echo $Language->Phrase("EmailFormContentTypeHtml") ?></label>
		<label><input type="radio" name="contenttype" value="url"><?php echo $Language->Phrase("EmailFormContentTypeUrl") ?></label>
		</span></td>
	</tr>
</table>
</form>
