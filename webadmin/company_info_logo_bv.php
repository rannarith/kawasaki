...
$company_info_logo_blobview = NULL; // Initialize page object first

class ccompany_info_logo_blobview extends ccompany_info {
	...
	// Page object name
	var $PageObjName = 'company_info_logo_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('company_info', 'x_logo');
...
// Create page object
if (!isset($company_info_logo_blobview)) $company_info_logo_blobview = new ccompany_info_logo_blobview();

// Page init
$company_info_logo_blobview->Page_Init();

// Page main
$company_info_logo_blobview->Page_Main();
?>
<?php
$company_info_logo_blobview->Page_Terminate();
?>
