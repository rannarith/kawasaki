...
// Page object
var model_gallery_edit = new ew_Page("model_gallery_edit");
model_gallery_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = model_gallery_edit.PageID; // For backward compatibility

// Form object
var fmodel_galleryedit = new ew_Form("fmodel_galleryedit");

// Validate form
fmodel_galleryedit.Validate = function(fobj) {
...
fmodel_galleryedit.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $model_gallery->TableCaption() ?></span></p>
...
?>
<form name="fmodel_galleryedit" id="fmodel_galleryedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="model_gallery">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_model_galleryedit" class="ewTable">
...
<input type="hidden" name="x_gallery_id" id="x_gallery_id" value="<?php echo ew_HtmlEncode($model_gallery->gallery_id->CurrentValue) ?>">
</span><?php echo $model_gallery->gallery_id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fmodel_galleryedit.Lists["x_model_id"].Options = <?php echo (is_array($model_gallery->model_id->EditValue)) ? ew_ArrayToJson($model_gallery->model_id->EditValue, 1) : "[]" ?>;
</script>
<?php } ?>
