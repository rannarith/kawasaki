...
$model_color_image_blobview = NULL; // Initialize page object first

class cmodel_color_image_blobview extends cmodel_color {
	...
	// Page object name
	var $PageObjName = 'model_color_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('model_color', 'x_image');
...
// Create page object
if (!isset($model_color_image_blobview)) $model_color_image_blobview = new cmodel_color_image_blobview();

// Page init
$model_color_image_blobview->Page_Init();

// Page main
$model_color_image_blobview->Page_Main();
?>
<?php
$model_color_image_blobview->Page_Terminate();
?>
