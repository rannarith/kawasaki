...
class cnews_gallery_edit extends cnews_gallery {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->ng_id->CurrentValue == "")
			$this->Page_Terminate("news_gallerylist.php"); // Invalid key, return to list
...
// Page object
var news_gallery_edit = new ew_Page("news_gallery_edit");
news_gallery_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = news_gallery_edit.PageID; // For backward compatibility

// Form object
var fnews_galleryedit = new ew_Form("fnews_galleryedit");

// Validate form
fnews_galleryedit.Validate = function(fobj) {
...
fnews_galleryedit.ValidateRequired = true;
<?php } else { ?>
fnews_galleryedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fnews_galleryedit.Lists["x_news_id"] = {"LinkField":"x_news_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $news_gallery->TableCaption() ?></span></p>
...
?>
<form name="fnews_galleryedit" id="fnews_galleryedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="news_gallery">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_news_galleryedit" class="ewTable">
...
<input type="hidden" name="x_ng_id" id="x_ng_id" value="<?php echo ew_HtmlEncode($news_gallery->ng_id->CurrentValue) ?>">
</span><?php echo $news_gallery->ng_id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fnews_galleryedit.Lists["x_news_id"].Options = <?php echo (is_array($news_gallery->news_id->EditValue)) ? ew_ArrayToJson($news_gallery->news_id->EditValue, 1) : "[]" ?>;
</script>
<?php } ?>
