...
class cnews_add extends cnews {
	...
	function ValidateForm() {
		...
		if ($this->getCurrentDetailTable() == "news_gallery" && $GLOBALS["news_gallery"]->DetailAdd) {
...
// Validate form
fnewsadd.Validate = function(fobj) {
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $news->TableCaption() ?></span></p>
...
?>
<form name="fnewsadd" id="fnewsadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="news">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_newsadd" class="ewTable">
...
&nbsp;<img src="phpimages/calendar.png" id="fnewsadd$x_news_date$" name="fnewsadd$x_news_date$" alt="<?php echo $Language->Phrase("PickDate") ?>" title="<?php echo $Language->Phrase("PickDate") ?>" class="ewCalendar">
<script type="text/javascript">
...
<p>
<?php if ($news->getCurrentDetailTable() == "news_gallery" && $news_gallery->DetailAdd) { ?>
<br>
