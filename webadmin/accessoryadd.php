		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "accessoryview.php")
...
// Page object
var accessory_add = new ew_Page("accessory_add");
accessory_add.PageID = "add"; // Page ID
var EW_PAGE_ID = accessory_add.PageID; // For backward compatibility

// Form object
var faccessoryadd = new ew_Form("faccessoryadd");

// Validate form
faccessoryadd.Validate = function(fobj) {
...
faccessoryadd.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $accessory->TableCaption() ?></span></p>
...
?>
<form name="faccessoryadd" id="faccessoryadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="accessory">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_accessoryadd" class="ewTable">
...
<script type="text/javascript">
ew_CreateEditor("faccessoryadd", "x_long_des", 50, 6, <?php echo ($accessory->long_des->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
faccessoryadd.Lists["x_model_id"].Options = <?php echo (is_array($accessory->model_id->EditValue)) ? ew_ArrayToJson($accessory->model_id->EditValue, 1) : "[]" ?>;
</script>
