...
// Page object
var promotion_edit = new ew_Page("promotion_edit");
promotion_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = promotion_edit.PageID; // For backward compatibility

// Form object
var fpromotionedit = new ew_Form("fpromotionedit");

// Validate form
fpromotionedit.Validate = function(fobj) {
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $promotion->TableCaption() ?></span></p>
...
?>
<form name="fpromotionedit" id="fpromotionedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="promotion">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_promotionedit" class="ewTable">
...
<?php echo $promotion->proid->EditValue ?></span>
<input type="hidden" name="x_proid" id="x_proid" value="<?php echo ew_HtmlEncode($promotion->proid->CurrentValue) ?>">
</span><?php echo $promotion->proid->CustomMsg ?></td>
	</tr>
<?php } ?>
