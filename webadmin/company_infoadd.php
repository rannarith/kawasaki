		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "company_infoview.php")
...
// Page object
var company_info_add = new ew_Page("company_info_add");
company_info_add.PageID = "add"; // Page ID
var EW_PAGE_ID = company_info_add.PageID; // For backward compatibility

// Form object
var fcompany_infoadd = new ew_Form("fcompany_infoadd");

// Validate form
fcompany_infoadd.Validate = function(fobj) {
...
fcompany_infoadd.ValidateRequired = true;
<?php } else { ?>
fcompany_infoadd.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $company_info->TableCaption() ?></span></p>
...
?>
<form name="fcompany_infoadd" id="fcompany_infoadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="company_info">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_company_infoadd" class="ewTable">
