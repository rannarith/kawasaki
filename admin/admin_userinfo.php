...
//
// Table class for admin_user
//
class cadmin_user extends cTable {
	var $_userid;
	var $username;
	var $password;
	var $_email;
	...
	function __construct() {
		...
		$this->TableVar = 'admin_user';
		$this->TableName = 'admin_user';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`admin_user`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userid
		$this->_userid = new cField('admin_user', 'admin_user', 'x__userid', 'userid', '`userid`', '`userid`', 3, -1, FALSE, '`userid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->_userid->Sortable = TRUE; // Allow sort
		$this->_userid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['userid'] = &$this->_userid;

		// username
		$this->username = new cField('admin_user', 'admin_user', 'x_username', 'username', '`username`', '`username`', 200, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->username->Sortable = TRUE; // Allow sort
		$this->fields['username'] = &$this->username;

		// password
		$this->password = new cField('admin_user', 'admin_user', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		$this->password->Sortable = TRUE; // Allow sort
		$this->fields['password'] = &$this->password;

		// email
		$this->_email = new cField('admin_user', 'admin_user', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// phone_number
		$this->phone_number = new cField('admin_user', 'admin_user', 'x_phone_number', 'phone_number', '`phone_number`', '`phone_number`', 200, -1, FALSE, '`phone_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`admin_user`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`userid` DESC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "admin_useredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "admin_useradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("admin_userview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("admin_userview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "admin_useradd.php?" . $this->UrlParm($parm);
		else
			$url = "admin_useradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("admin_useredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("admin_useradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("admin_userdelete.php", $this->UrlParm());
	}
