...
//
// Table class for company_info
//
class ccompany_info extends cTable {
	var $cid;
	var $company_name;
	var $logo;
	var $address;
	...
	function __construct() {
		...
		$this->TableVar = 'company_info';
		$this->TableName = 'company_info';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`company_info`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// cid
		$this->cid = new cField('company_info', 'company_info', 'x_cid', 'cid', '`cid`', '`cid`', 3, -1, FALSE, '`cid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->cid->Sortable = TRUE; // Allow sort
		$this->cid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cid'] = &$this->cid;

		// company_name
		$this->company_name = new cField('company_info', 'company_info', 'x_company_name', 'company_name', '`company_name`', '`company_name`', 200, -1, FALSE, '`company_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->company_name->Sortable = TRUE; // Allow sort
		$this->fields['company_name'] = &$this->company_name;

		// logo
		$this->logo = new cField('company_info', 'company_info', 'x_logo', 'logo', '`logo`', '`logo`', 200, -1, FALSE, '`logo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->logo->Sortable = TRUE; // Allow sort
		$this->fields['logo'] = &$this->logo;

		// address
		$this->address = new cField('company_info', 'company_info', 'x_address', 'address', '`address`', '`address`', 201, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->address->Sortable = TRUE; // Allow sort
		$this->fields['address'] = &$this->address;

		// email
		$this->_email = new cField('company_info', 'company_info', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// phone_number
		$this->phone_number = new cField('company_info', 'company_info', 'x_phone_number', 'phone_number', '`phone_number`', '`phone_number`', 200, -1, FALSE, '`phone_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone_number->Sortable = TRUE; // Allow sort
		$this->fields['phone_number'] = &$this->phone_number;

		// status
		$this->status = new cField('company_info', 'company_info', 'x_status', 'status', '`status`', '`status`', 16, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`company_info`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "company_infoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "company_infoadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("company_infoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("company_infoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "company_infoadd.php?" . $this->UrlParm($parm);
		else
			$url = "company_infoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("company_infoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("company_infoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("company_infodelete.php", $this->UrlParm());
	}
