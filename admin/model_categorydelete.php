	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("model_categorylist.php"); // Return to list
			}
		}
	}
...
$model_category_delete->Page_Render();
?>
...
var CurrentForm = fmodel_categorydelete = new ew_Form("fmodel_categorydelete", "delete");
...
fmodel_categorydelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmodel_categorydelete.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmodel_categorydelete.Lists["x_status"].Options = <?php echo json_encode($model_category_delete->status->Options()) ?>;
...
?>
<form name="fmodel_categorydelete" id="fmodel_categorydelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($model_category_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $model_category_delete->Token ?>">
<?php } ?>
...
<?php if ($model_category->category_id->Visible) { // category_id ?>
		<th class="<?php echo $model_category->category_id->HeaderCellClass() ?>"><span id="elh_model_category_category_id" class="model_category_category_id"><?php echo $model_category->category_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_category->category_name->Visible) { // category_name ?>
		<th class="<?php echo $model_category->category_name->HeaderCellClass() ?>"><span id="elh_model_category_category_name" class="model_category_category_name"><?php echo $model_category->category_name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_category->c_order->Visible) { // c_order ?>
		<th class="<?php echo $model_category->c_order->HeaderCellClass() ?>"><span id="elh_model_category_c_order" class="model_category_c_order"><?php echo $model_category->c_order->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_category->status->Visible) { // status ?>
		<th class="<?php echo $model_category->status->HeaderCellClass() ?>"><span id="elh_model_category_status" class="model_category_status"><?php echo $model_category->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $model_category_delete->RowCnt ?>_model_category_category_id" class="model_category_category_id">
...
<span id="el<?php echo $model_category_delete->RowCnt ?>_model_category_category_name" class="model_category_category_name">
...
<span id="el<?php echo $model_category_delete->RowCnt ?>_model_category_c_order" class="model_category_c_order">
...
<span id="el<?php echo $model_category_delete->RowCnt ?>_model_category_status" class="model_category_status">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $model_category_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
