	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("news_gallerylist.php"); // Return to list
			}
		}
	}
...
$news_gallery_delete->Page_Render();
?>
...
var CurrentForm = fnews_gallerydelete = new ew_Form("fnews_gallerydelete", "delete");
...
fnews_gallerydelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fnews_gallerydelete.Lists["x_news_id"] = {"LinkField":"x_news_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"news"};
fnews_gallerydelete.Lists["x_news_id"].Data = "<?php echo $news_gallery_delete->news_id->LookupFilterQuery(FALSE, "delete") ?>";
fnews_gallerydelete.Lists["x_g_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnews_gallerydelete.Lists["x_g_status"].Options = <?php echo json_encode($news_gallery_delete->g_status->Options()) ?>;
...
?>
<form name="fnews_gallerydelete" id="fnews_gallerydelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($news_gallery_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $news_gallery_delete->Token ?>">
<?php } ?>
...
<?php if ($news_gallery->ng_id->Visible) { // ng_id ?>
		<th class="<?php echo $news_gallery->ng_id->HeaderCellClass() ?>"><span id="elh_news_gallery_ng_id" class="news_gallery_ng_id"><?php echo $news_gallery->ng_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news_gallery->news_id->Visible) { // news_id ?>
		<th class="<?php echo $news_gallery->news_id->HeaderCellClass() ?>"><span id="elh_news_gallery_news_id" class="news_gallery_news_id"><?php echo $news_gallery->news_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news_gallery->image->Visible) { // image ?>
		<th class="<?php echo $news_gallery->image->HeaderCellClass() ?>"><span id="elh_news_gallery_image" class="news_gallery_image"><?php echo $news_gallery->image->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news_gallery->g_order->Visible) { // g_order ?>
		<th class="<?php echo $news_gallery->g_order->HeaderCellClass() ?>"><span id="elh_news_gallery_g_order" class="news_gallery_g_order"><?php echo $news_gallery->g_order->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news_gallery->g_status->Visible) { // g_status ?>
		<th class="<?php echo $news_gallery->g_status->HeaderCellClass() ?>"><span id="elh_news_gallery_g_status" class="news_gallery_g_status"><?php echo $news_gallery->g_status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($news_gallery->ng_id->Visible) { // ng_id ?>
		<td<?php echo $news_gallery->ng_id->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_ng_id" class="news_gallery_ng_id">
...
<?php } ?>
<?php if ($news_gallery->news_id->Visible) { // news_id ?>
		<td<?php echo $news_gallery->news_id->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_news_id" class="news_gallery_news_id">
...
<?php } ?>
<?php if ($news_gallery->image->Visible) { // image ?>
		<td<?php echo $news_gallery->image->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_image" class="news_gallery_image">
<span>
...
<?php } ?>
<?php if ($news_gallery->g_order->Visible) { // g_order ?>
		<td<?php echo $news_gallery->g_order->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_g_order" class="news_gallery_g_order">
...
<?php } ?>
<?php if ($news_gallery->g_status->Visible) { // g_status ?>
		<td<?php echo $news_gallery->g_status->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_g_status" class="news_gallery_g_status">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $news_gallery_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
