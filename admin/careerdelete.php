	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("careerlist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fcareerdelete = new ew_Form("fcareerdelete", "delete");
...
fcareerdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcareerdelete.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcareerdelete.Lists["x_status"].Options = <?php echo json_encode($career_delete->status->Options()) ?>;
...
?>
<form name="fcareerdelete" id="fcareerdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($career_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $career_delete->Token ?>">
<?php } ?>
...
<?php if ($career->cid->Visible) { // cid ?>
		<th class="<?php echo $career->cid->HeaderCellClass() ?>"><span id="elh_career_cid" class="career_cid"><?php echo $career->cid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($career->position->Visible) { // position ?>
		<th class="<?php echo $career->position->HeaderCellClass() ?>"><span id="elh_career_position" class="career_position"><?php echo $career->position->FldCaption() ?></span></th>
<?php } ?>
<?php if ($career->create_date->Visible) { // create_date ?>
		<th class="<?php echo $career->create_date->HeaderCellClass() ?>"><span id="elh_career_create_date" class="career_create_date"><?php echo $career->create_date->FldCaption() ?></span></th>
<?php } ?>
<?php if ($career->closing_date->Visible) { // closing_date ?>
		<th class="<?php echo $career->closing_date->HeaderCellClass() ?>"><span id="elh_career_closing_date" class="career_closing_date"><?php echo $career->closing_date->FldCaption() ?></span></th>
<?php } ?>
<?php if ($career->status->Visible) { // status ?>
		<th class="<?php echo $career->status->HeaderCellClass() ?>"><span id="elh_career_status" class="career_status"><?php echo $career->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($career->cid->Visible) { // cid ?>
		<td<?php echo $career->cid->CellAttributes() ?>>
<span id="el<?php echo $career_delete->RowCnt ?>_career_cid" class="career_cid">
...
<?php } ?>
<?php if ($career->position->Visible) { // position ?>
		<td<?php echo $career->position->CellAttributes() ?>>
<span id="el<?php echo $career_delete->RowCnt ?>_career_position" class="career_position">
...
<?php } ?>
<?php if ($career->create_date->Visible) { // create_date ?>
		<td<?php echo $career->create_date->CellAttributes() ?>>
<span id="el<?php echo $career_delete->RowCnt ?>_career_create_date" class="career_create_date">
...
<?php } ?>
<?php if ($career->closing_date->Visible) { // closing_date ?>
		<td<?php echo $career->closing_date->CellAttributes() ?>>
<span id="el<?php echo $career_delete->RowCnt ?>_career_closing_date" class="career_closing_date">
...
<?php } ?>
<?php if ($career->status->Visible) { // status ?>
		<td<?php echo $career->status->CellAttributes() ?>>
<span id="el<?php echo $career_delete->RowCnt ?>_career_status" class="career_status">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $career_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fcareerdelete.Init();
