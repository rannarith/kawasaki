...
define("EW_PROJECT_NAME", "admin3_download", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{086EEFE9-31D6-48E2-919A-4B361863B384}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'nSJsmHDmpcN55J8T', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/admin3_download.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "kawasaki", "qs" => "`", "qe" => "`");
...
$EW_LANGUAGE_FILE[] = array("English", "", "english.xml");
define("EW_LANGUAGE_DEFAULT_ID", "English", TRUE);
...
define("EW_ADMIN_PASSWORD", "kawa!@#", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`admin_user`", TRUE);
...
define("EW_UPLOAD_DEST_PATH", "../assets/", TRUE); // Upload destination path (relative to app root)
