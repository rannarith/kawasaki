...
//
// Table class for about_gallery
//
class cabout_gallery extends cTable {
	var $aid;
	var $image;
	var $img_order;
	var $status;
	...
	function __construct() {
		...
		$this->TableVar = 'about_gallery';
		$this->TableName = 'about_gallery';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`about_gallery`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// aid
		$this->aid = new cField('about_gallery', 'about_gallery', 'x_aid', 'aid', '`aid`', '`aid`', 3, -1, FALSE, '`aid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->aid->Sortable = TRUE; // Allow sort
		$this->aid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['aid'] = &$this->aid;

		// image
		$this->image = new cField('about_gallery', 'about_gallery', 'x_image', 'image', '`image`', '`image`', 200, -1, TRUE, '`image`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->image->Sortable = TRUE; // Allow sort
		$this->fields['image'] = &$this->image;

		// img_order
		$this->img_order = new cField('about_gallery', 'about_gallery', 'x_img_order', 'img_order', '`img_order`', '`img_order`', 16, -1, FALSE, '`img_order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new cField('about_gallery', 'about_gallery', 'x_status', 'status', '`status`', '`status`', 16, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`about_gallery`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`aid` DESC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "about_galleryedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "about_galleryadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("about_galleryview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("about_galleryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "about_galleryadd.php?" . $this->UrlParm($parm);
		else
			$url = "about_galleryadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("about_galleryedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("about_galleryadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("about_gallerydelete.php", $this->UrlParm());
	}
