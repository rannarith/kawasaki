...
$special_offer_view = NULL; // Initialize page object first

class cspecial_offer_view extends cspecial_offer {
	...
	// Page object name
	var $PageObjName = 'special_offer_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "special_offerlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "special_offerlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "special_offerlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($special_offer_view)) $special_offer_view = new cspecial_offer_view();

// Page init
$special_offer_view->Page_Init();

// Page main
$special_offer_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$special_offer_view->Page_Render();
?>
...
var CurrentForm = fspecial_offerview = new ew_Form("fspecial_offerview", "view");

// Form_CustomValidate event
fspecial_offerview.Form_CustomValidate = 
...
fspecial_offerview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fspecial_offerview.Lists["x_is_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fspecial_offerview.Lists["x_is_active"].Options = <?php echo json_encode($special_offer_view->is_active->Options()) ?>;
...
<div class="ewToolbar">
<?php $special_offer_view->ExportOptions->Render("body") ?>
<?php
	foreach ($special_offer_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $special_offer_view->ShowPageHeader(); ?>
<?php
$special_offer_view->ShowMessage();
?>
<form name="fspecial_offerview" id="fspecial_offerview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($special_offer_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $special_offer_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="special_offer">
<input type="hidden" name="modal" value="<?php echo intval($special_offer_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($special_offer->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_special_offer_id"><?php echo $special_offer->id->FldCaption() ?></span></td>
...
<?php echo $special_offer->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($special_offer->title_small->Visible) { // title_small ?>
	<tr id="r_title_small">
		<td class="col-sm-2"><span id="elh_special_offer_title_small"><?php echo $special_offer->title_small->FldCaption() ?></span></td>
...
<?php echo $special_offer->title_small->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($special_offer->title->Visible) { // title ?>
	<tr id="r_title">
		<td class="col-sm-2"><span id="elh_special_offer_title"><?php echo $special_offer->title->FldCaption() ?></span></td>
...
<?php echo $special_offer->title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($special_offer->url_slug->Visible) { // url_slug ?>
	<tr id="r_url_slug">
		<td class="col-sm-2"><span id="elh_special_offer_url_slug"><?php echo $special_offer->url_slug->FldCaption() ?></span></td>
...
<?php echo $special_offer->url_slug->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($special_offer->_thumbnail->Visible) { // thumbnail ?>
	<tr id="r__thumbnail">
		<td class="col-sm-2"><span id="elh_special_offer__thumbnail"><?php echo $special_offer->_thumbnail->FldCaption() ?></span></td>
		<td data-name="_thumbnail"<?php echo $special_offer->_thumbnail->CellAttributes() ?>>
<span id="el_special_offer__thumbnail">
<span>
<?php echo ew_GetFileViewTag($special_offer->_thumbnail, $special_offer->_thumbnail->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($special_offer->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_special_offer_description"><?php echo $special_offer->description->FldCaption() ?></span></td>
		<td data-name="description"<?php echo $special_offer->description->CellAttributes() ?>>
<span id="el_special_offer_description">
<span<?php echo $special_offer->description->ViewAttributes() ?>>
<?php echo $special_offer->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($special_offer->linkto->Visible) { // linkto ?>
	<tr id="r_linkto">
		<td class="col-sm-2"><span id="elh_special_offer_linkto"><?php echo $special_offer->linkto->FldCaption() ?></span></td>
...
<?php echo $special_offer->linkto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($special_offer->is_active->Visible) { // is_active ?>
	<tr id="r_is_active">
		<td class="col-sm-2"><span id="elh_special_offer_is_active"><?php echo $special_offer->is_active->FldCaption() ?></span></td>
...
<?php echo $special_offer->is_active->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($special_offer->create_date->Visible) { // create_date ?>
	<tr id="r_create_date">
		<td class="col-sm-2"><span id="elh_special_offer_create_date"><?php echo $special_offer->create_date->FldCaption() ?></span></td>
		<td data-name="create_date"<?php echo $special_offer->create_date->CellAttributes() ?>>
<span id="el_special_offer_create_date">
<span<?php echo $special_offer->create_date->ViewAttributes() ?>>
<?php echo $special_offer->create_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fspecial_offerview.Init();
</script>
<?php
$special_offer_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$special_offer_view->Page_Terminate();
?>
