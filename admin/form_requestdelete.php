...
class cform_request_delete extends cform_request {
	...
	function Page_Init() {
		...
		if (!$Security->CanDelete()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("form_requestlist.php"));
			else
	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("form_requestlist.php"); // Return to list
			}
		}
	}
...
$form_request_delete->Page_Render();
?>
...
var CurrentForm = fform_requestdelete = new ew_Form("fform_requestdelete", "delete");
...
fform_requestdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fform_requestdelete" id="fform_requestdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($form_request_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $form_request_delete->Token ?>">
<?php } ?>
...
<?php if ($form_request->fr_id->Visible) { // fr_id ?>
		<th class="<?php echo $form_request->fr_id->HeaderCellClass() ?>"><span id="elh_form_request_fr_id" class="form_request_fr_id"><?php echo $form_request->fr_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($form_request->fullname->Visible) { // fullname ?>
		<th class="<?php echo $form_request->fullname->HeaderCellClass() ?>"><span id="elh_form_request_fullname" class="form_request_fullname"><?php echo $form_request->fullname->FldCaption() ?></span></th>
<?php } ?>
<?php if ($form_request->_email->Visible) { // email ?>
		<th class="<?php echo $form_request->_email->HeaderCellClass() ?>"><span id="elh_form_request__email" class="form_request__email"><?php echo $form_request->_email->FldCaption() ?></span></th>
<?php } ?>
<?php if ($form_request->phone->Visible) { // phone ?>
		<th class="<?php echo $form_request->phone->HeaderCellClass() ?>"><span id="elh_form_request_phone" class="form_request_phone"><?php echo $form_request->phone->FldCaption() ?></span></th>
<?php } ?>
<?php if ($form_request->model->Visible) { // model ?>
		<th class="<?php echo $form_request->model->HeaderCellClass() ?>"><span id="elh_form_request_model" class="form_request_model"><?php echo $form_request->model->FldCaption() ?></span></th>
<?php } ?>
<?php if ($form_request->date_submit->Visible) { // date_submit ?>
		<th class="<?php echo $form_request->date_submit->HeaderCellClass() ?>"><span id="elh_form_request_date_submit" class="form_request_date_submit"><?php echo $form_request->date_submit->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($form_request->fr_id->Visible) { // fr_id ?>
		<td<?php echo $form_request->fr_id->CellAttributes() ?>>
<span id="el<?php echo $form_request_delete->RowCnt ?>_form_request_fr_id" class="form_request_fr_id">
...
<?php } ?>
<?php if ($form_request->fullname->Visible) { // fullname ?>
		<td<?php echo $form_request->fullname->CellAttributes() ?>>
<span id="el<?php echo $form_request_delete->RowCnt ?>_form_request_fullname" class="form_request_fullname">
...
<?php } ?>
<?php if ($form_request->_email->Visible) { // email ?>
		<td<?php echo $form_request->_email->CellAttributes() ?>>
<span id="el<?php echo $form_request_delete->RowCnt ?>_form_request__email" class="form_request__email">
...
<?php } ?>
<?php if ($form_request->phone->Visible) { // phone ?>
		<td<?php echo $form_request->phone->CellAttributes() ?>>
<span id="el<?php echo $form_request_delete->RowCnt ?>_form_request_phone" class="form_request_phone">
...
<?php } ?>
<?php if ($form_request->model->Visible) { // model ?>
		<td<?php echo $form_request->model->CellAttributes() ?>>
<span id="el<?php echo $form_request_delete->RowCnt ?>_form_request_model" class="form_request_model">
...
<?php } ?>
<?php if ($form_request->date_submit->Visible) { // date_submit ?>
		<td<?php echo $form_request->date_submit->CellAttributes() ?>>
<span id="el<?php echo $form_request_delete->RowCnt ?>_form_request_date_submit" class="form_request_date_submit">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $form_request_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
