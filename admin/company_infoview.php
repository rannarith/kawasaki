...
var CurrentForm = fcompany_infoview = new ew_Form("fcompany_infoview", "view");
...
fcompany_infoview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $company_info_view->ExportOptions->Render("body") ?>
<?php
	foreach ($company_info_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fcompany_infoview" id="fcompany_infoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($company_info_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $company_info_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="company_info">
<input type="hidden" name="modal" value="<?php echo intval($company_info_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($company_info->cid->Visible) { // cid ?>
	<tr id="r_cid">
		<td class="col-sm-2"><span id="elh_company_info_cid"><?php echo $company_info->cid->FldCaption() ?></span></td>
...
<?php if ($company_info->company_name->Visible) { // company_name ?>
	<tr id="r_company_name">
		<td class="col-sm-2"><span id="elh_company_info_company_name"><?php echo $company_info->company_name->FldCaption() ?></span></td>
...
<?php if ($company_info->logo->Visible) { // logo ?>
	<tr id="r_logo">
		<td class="col-sm-2"><span id="elh_company_info_logo"><?php echo $company_info->logo->FldCaption() ?></span></td>
...
<?php echo $company_info->logo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($company_info->address->Visible) { // address ?>
	<tr id="r_address">
		<td class="col-sm-2"><span id="elh_company_info_address"><?php echo $company_info->address->FldCaption() ?></span></td>
		<td data-name="address"<?php echo $company_info->address->CellAttributes() ?>>
...
<?php if ($company_info->_email->Visible) { // email ?>
	<tr id="r__email">
		<td class="col-sm-2"><span id="elh_company_info__email"><?php echo $company_info->_email->FldCaption() ?></span></td>
...
<?php if ($company_info->phone_number->Visible) { // phone_number ?>
	<tr id="r_phone_number">
		<td class="col-sm-2"><span id="elh_company_info_phone_number"><?php echo $company_info->phone_number->FldCaption() ?></span></td>
...
<?php if ($company_info->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_company_info_status"><?php echo $company_info->status->FldCaption() ?></span></td>
