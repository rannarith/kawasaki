...
fpromotionview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($promotion_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($promotion->proid->Visible) { // proid ?>
	<tr id="r_proid">
		<td class="col-sm-2"><span id="elh_promotion_proid"><?php echo $promotion->proid->FldCaption() ?></span></td>
...
<?php if ($promotion->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_promotion_image"><?php echo $promotion->image->FldCaption() ?></span></td>
...
<?php if ($promotion->pro_title->Visible) { // pro_title ?>
	<tr id="r_pro_title">
		<td class="col-sm-2"><span id="elh_promotion_pro_title"><?php echo $promotion->pro_title->FldCaption() ?></span></td>
...
<?php if ($promotion->pro_des->Visible) { // pro_des ?>
	<tr id="r_pro_des">
		<td class="col-sm-2"><span id="elh_promotion_pro_des"><?php echo $promotion->pro_des->FldCaption() ?></span></td>
...
<?php if ($promotion->pro_date->Visible) { // pro_date ?>
	<tr id="r_pro_date">
		<td class="col-sm-2"><span id="elh_promotion_pro_date"><?php echo $promotion->pro_date->FldCaption() ?></span></td>
...
<?php if ($promotion->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_promotion_status"><?php echo $promotion->status->FldCaption() ?></span></td>
