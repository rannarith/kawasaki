	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("model_colorlist.php"); // Return to list
			}
		}
	}
...
$model_color_delete->Page_Render();
?>
...
var CurrentForm = fmodel_colordelete = new ew_Form("fmodel_colordelete", "delete");
...
fmodel_colordelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmodel_colordelete.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"model"};
fmodel_colordelete.Lists["x_model_id"].Data = "<?php echo $model_color_delete->model_id->LookupFilterQuery(FALSE, "delete") ?>";
fmodel_colordelete.Lists["x_m_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmodel_colordelete.Lists["x_m_status"].Options = <?php echo json_encode($model_color_delete->m_status->Options()) ?>;
...
?>
<form name="fmodel_colordelete" id="fmodel_colordelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($model_color_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $model_color_delete->Token ?>">
<?php } ?>
...
<?php if ($model_color->mc_id->Visible) { // mc_id ?>
		<th class="<?php echo $model_color->mc_id->HeaderCellClass() ?>"><span id="elh_model_color_mc_id" class="model_color_mc_id"><?php echo $model_color->mc_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_color->image->Visible) { // image ?>
		<th class="<?php echo $model_color->image->HeaderCellClass() ?>"><span id="elh_model_color_image" class="model_color_image"><?php echo $model_color->image->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_color->model_id->Visible) { // model_id ?>
		<th class="<?php echo $model_color->model_id->HeaderCellClass() ?>"><span id="elh_model_color_model_id" class="model_color_model_id"><?php echo $model_color->model_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_color->color_code->Visible) { // color_code ?>
		<th class="<?php echo $model_color->color_code->HeaderCellClass() ?>"><span id="elh_model_color_color_code" class="model_color_color_code"><?php echo $model_color->color_code->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_color->m_order->Visible) { // m_order ?>
		<th class="<?php echo $model_color->m_order->HeaderCellClass() ?>"><span id="elh_model_color_m_order" class="model_color_m_order"><?php echo $model_color->m_order->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_color->m_status->Visible) { // m_status ?>
		<th class="<?php echo $model_color->m_status->HeaderCellClass() ?>"><span id="elh_model_color_m_status" class="model_color_m_status"><?php echo $model_color->m_status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($model_color->mc_id->Visible) { // mc_id ?>
		<td<?php echo $model_color->mc_id->CellAttributes() ?>>
<span id="el<?php echo $model_color_delete->RowCnt ?>_model_color_mc_id" class="model_color_mc_id">
...
<?php } ?>
<?php if ($model_color->image->Visible) { // image ?>
		<td<?php echo $model_color->image->CellAttributes() ?>>
<span id="el<?php echo $model_color_delete->RowCnt ?>_model_color_image" class="model_color_image">
<span>
...
<?php } ?>
<?php if ($model_color->model_id->Visible) { // model_id ?>
		<td<?php echo $model_color->model_id->CellAttributes() ?>>
<span id="el<?php echo $model_color_delete->RowCnt ?>_model_color_model_id" class="model_color_model_id">
...
<?php } ?>
<?php if ($model_color->color_code->Visible) { // color_code ?>
		<td<?php echo $model_color->color_code->CellAttributes() ?>>
<span id="el<?php echo $model_color_delete->RowCnt ?>_model_color_color_code" class="model_color_color_code">
...
<?php } ?>
<?php if ($model_color->m_order->Visible) { // m_order ?>
		<td<?php echo $model_color->m_order->CellAttributes() ?>>
<span id="el<?php echo $model_color_delete->RowCnt ?>_model_color_m_order" class="model_color_m_order">
...
<?php } ?>
<?php if ($model_color->m_status->Visible) { // m_status ?>
		<td<?php echo $model_color->m_status->CellAttributes() ?>>
<span id="el<?php echo $model_color_delete->RowCnt ?>_model_color_m_status" class="model_color_m_status">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $model_color_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
