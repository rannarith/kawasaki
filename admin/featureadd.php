...
class cfeature_add extends cfeature {
	...
	function NewRow() {
		...
		$row = array();
		$row['feature_id'] = $this->feature_id->CurrentValue;
		$row['top_title'] = $this->top_title->CurrentValue;
		...
		$row['f_order'] = $this->f_order->CurrentValue;
		return $row;
	}
...
ffeatureadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ffeatureadd.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"model"};
ffeatureadd.Lists["x_model_id"].Data = "<?php echo $feature_add->model_id->LookupFilterQuery(FALSE, "add") ?>";
...
<input type="hidden" name="modal" value="<?php echo intval($feature_add->IsModal) ?>">
...
<?php if ($feature->top_title->Visible) { // top_title ?>
	<div id="r_top_title" class="form-group">
		<label id="elh_feature_top_title" for="x_top_title" class="<?php echo $feature_add->LeftColumnClass ?>"><?php echo $feature->top_title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $feature_add->RightColumnClass ?>"><div<?php echo $feature->top_title->CellAttributes() ?>>
...
<?php if ($feature->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_feature_title" for="x_title" class="<?php echo $feature_add->LeftColumnClass ?>"><?php echo $feature->title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $feature_add->RightColumnClass ?>"><div<?php echo $feature->title->CellAttributes() ?>>
...
<?php if ($feature->model_id->Visible) { // model_id ?>
	<div id="r_model_id" class="form-group">
		<label id="elh_feature_model_id" for="x_model_id" class="<?php echo $feature_add->LeftColumnClass ?>"><?php echo $feature->model_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $feature_add->RightColumnClass ?>"><div<?php echo $feature->model_id->CellAttributes() ?>>
...
<?php if ($feature->_thumbnail->Visible) { // thumbnail ?>
	<div id="r__thumbnail" class="form-group">
		<label id="elh_feature__thumbnail" class="<?php echo $feature_add->LeftColumnClass ?>"><?php echo $feature->_thumbnail->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $feature_add->RightColumnClass ?>"><div<?php echo $feature->_thumbnail->CellAttributes() ?>>
...
<?php if ($feature->long_des->Visible) { // long_des ?>
	<div id="r_long_des" class="form-group">
		<label id="elh_feature_long_des" class="<?php echo $feature_add->LeftColumnClass ?>"><?php echo $feature->long_des->FldCaption() ?></label>
		<div class="<?php echo $feature_add->RightColumnClass ?>"><div<?php echo $feature->long_des->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("ffeatureadd", "x_long_des", 45, 6, <?php echo ($feature->long_des->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($feature->f_order->Visible) { // f_order ?>
	<div id="r_f_order" class="form-group">
		<label id="elh_feature_f_order" for="x_f_order" class="<?php echo $feature_add->LeftColumnClass ?>"><?php echo $feature->f_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $feature_add->RightColumnClass ?>"><div<?php echo $feature->f_order->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $feature_add->OffsetColumnClass ?>"><!-- buttons offset -->
