...
class cnews_gallery_add extends cnews_gallery {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "news_galleryview.php")
	...
	function NewRow() {
		...
		$row = array();
		$row['ng_id'] = $this->ng_id->CurrentValue;
		$row['news_id'] = $this->news_id->CurrentValue;
		$row['image'] = $this->image->Upload->DbValue;
		$row['g_order'] = $this->g_order->CurrentValue;
		$row['g_status'] = $this->g_status->CurrentValue;
		return $row;
	}
...
var CurrentForm = fnews_galleryadd = new ew_Form("fnews_galleryadd", "add");

// Validate form
fnews_galleryadd.Validate = function() {
...
fnews_galleryadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fnews_galleryadd.Lists["x_news_id"] = {"LinkField":"x_news_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"news"};
fnews_galleryadd.Lists["x_news_id"].Data = "<?php echo $news_gallery_add->news_id->LookupFilterQuery(FALSE, "add") ?>";
fnews_galleryadd.Lists["x_g_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnews_galleryadd.Lists["x_g_status"].Options = <?php echo json_encode($news_gallery_add->g_status->Options()) ?>;
...
?>
<form name="fnews_galleryadd" id="fnews_galleryadd" class="<?php echo $news_gallery_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($news_gallery_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $news_gallery_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="news_gallery">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($news_gallery_add->IsModal) ?>">
...
<?php if ($news_gallery->news_id->Visible) { // news_id ?>
	<div id="r_news_id" class="form-group">
		<label id="elh_news_gallery_news_id" for="x_news_id" class="<?php echo $news_gallery_add->LeftColumnClass ?>"><?php echo $news_gallery->news_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $news_gallery_add->RightColumnClass ?>"><div<?php echo $news_gallery->news_id->CellAttributes() ?>>
...
<?php if ($news_gallery->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_news_gallery_image" class="<?php echo $news_gallery_add->LeftColumnClass ?>"><?php echo $news_gallery->image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $news_gallery_add->RightColumnClass ?>"><div<?php echo $news_gallery->image->CellAttributes() ?>>
...
<?php if ($news_gallery->g_order->Visible) { // g_order ?>
	<div id="r_g_order" class="form-group">
		<label id="elh_news_gallery_g_order" for="x_g_order" class="<?php echo $news_gallery_add->LeftColumnClass ?>"><?php echo $news_gallery->g_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $news_gallery_add->RightColumnClass ?>"><div<?php echo $news_gallery->g_order->CellAttributes() ?>>
...
<?php if ($news_gallery->g_status->Visible) { // g_status ?>
	<div id="r_g_status" class="form-group">
		<label id="elh_news_gallery_g_status" for="x_g_status" class="<?php echo $news_gallery_add->LeftColumnClass ?>"><?php echo $news_gallery->g_status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $news_gallery_add->RightColumnClass ?>"><div<?php echo $news_gallery->g_status->CellAttributes() ?>>
...
<?php if (!$news_gallery_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $news_gallery_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $news_gallery_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
