...
$social_community_view = NULL; // Initialize page object first

class csocial_community_view extends csocial_community {
	...
	// Page object name
	var $PageObjName = 'social_community_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "social_communitylist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "social_communitylist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "social_communitylist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($social_community_view)) $social_community_view = new csocial_community_view();

// Page init
$social_community_view->Page_Init();

// Page main
$social_community_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$social_community_view->Page_Render();
?>
...
var CurrentForm = fsocial_communityview = new ew_Form("fsocial_communityview", "view");

// Form_CustomValidate event
fsocial_communityview.Form_CustomValidate = 
...
fsocial_communityview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fsocial_communityview.Lists["x_social_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fsocial_communityview.Lists["x_social_type"].Options = <?php echo json_encode($social_community_view->social_type->Options()) ?>;
fsocial_communityview.Lists["x_is_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fsocial_communityview.Lists["x_is_active"].Options = <?php echo json_encode($social_community_view->is_active->Options()) ?>;
...
<div class="ewToolbar">
<?php $social_community_view->ExportOptions->Render("body") ?>
<?php
	foreach ($social_community_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $social_community_view->ShowPageHeader(); ?>
<?php
$social_community_view->ShowMessage();
?>
<form name="fsocial_communityview" id="fsocial_communityview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($social_community_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $social_community_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="social_community">
<input type="hidden" name="modal" value="<?php echo intval($social_community_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($social_community->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_social_community_id"><?php echo $social_community->id->FldCaption() ?></span></td>
...
<?php echo $social_community->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($social_community->_thumbnail->Visible) { // thumbnail ?>
	<tr id="r__thumbnail">
		<td class="col-sm-2"><span id="elh_social_community__thumbnail"><?php echo $social_community->_thumbnail->FldCaption() ?></span></td>
		<td data-name="_thumbnail"<?php echo $social_community->_thumbnail->CellAttributes() ?>>
<span id="el_social_community__thumbnail">
<span>
<?php echo ew_GetFileViewTag($social_community->_thumbnail, $social_community->_thumbnail->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($social_community->little->Visible) { // little ?>
	<tr id="r_little">
		<td class="col-sm-2"><span id="elh_social_community_little"><?php echo $social_community->little->FldCaption() ?></span></td>
...
<?php echo $social_community->little->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($social_community->linkto->Visible) { // linkto ?>
	<tr id="r_linkto">
		<td class="col-sm-2"><span id="elh_social_community_linkto"><?php echo $social_community->linkto->FldCaption() ?></span></td>
...
<?php echo $social_community->linkto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($social_community->social_type->Visible) { // social_type ?>
	<tr id="r_social_type">
		<td class="col-sm-2"><span id="elh_social_community_social_type"><?php echo $social_community->social_type->FldCaption() ?></span></td>
...
<?php echo $social_community->social_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($social_community->create_date->Visible) { // create_date ?>
	<tr id="r_create_date">
		<td class="col-sm-2"><span id="elh_social_community_create_date"><?php echo $social_community->create_date->FldCaption() ?></span></td>
		<td data-name="create_date"<?php echo $social_community->create_date->CellAttributes() ?>>
<span id="el_social_community_create_date">
<span<?php echo $social_community->create_date->ViewAttributes() ?>>
<?php echo $social_community->create_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($social_community->is_active->Visible) { // is_active ?>
	<tr id="r_is_active">
		<td class="col-sm-2"><span id="elh_social_community_is_active"><?php echo $social_community->is_active->FldCaption() ?></span></td>
...
<?php echo $social_community->is_active->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fsocial_communityview.Init();
</script>
<?php
$social_community_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$social_community_view->Page_Terminate();
?>
