...
class cmodel_gallery_edit extends cmodel_gallery {
		...
		if ($url <> "") {
			...
			if ($this->IsModal) { // Show as modal
				...
				if ($pageName != $this->GetListUrl()) { // Not List page
					...
					if ($pageName == "model_galleryview.php")
						$row["view"] = "1";
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_gallery_id")) {
			...
			if (isset($_GET["gallery_id"])) {
				...
				$this->gallery_id->CurrentValue = NULL;
			}
		}
...
fmodel_galleryedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
fmodel_galleryedit.Lists["x_model_id"].Data = "<?php echo $model_gallery_edit->model_id->LookupFilterQuery(FALSE, "edit") ?>";
...
fmodel_galleryedit.Lists["x_status"].Options = <?php echo json_encode($model_gallery_edit->status->Options()) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($model_gallery_edit->IsModal) ?>">
<?php if ($model_gallery->getCurrentMasterTable() == "model") { ?>
...
<?php if ($model_gallery->gallery_id->Visible) { // gallery_id ?>
	<div id="r_gallery_id" class="form-group">
		<label id="elh_model_gallery_gallery_id" class="<?php echo $model_gallery_edit->LeftColumnClass ?>"><?php echo $model_gallery->gallery_id->FldCaption() ?></label>
		<div class="<?php echo $model_gallery_edit->RightColumnClass ?>"><div<?php echo $model_gallery->gallery_id->CellAttributes() ?>>
...
<?php if ($model_gallery->model_id->Visible) { // model_id ?>
	<div id="r_model_id" class="form-group">
		<label id="elh_model_gallery_model_id" for="x_model_id" class="<?php echo $model_gallery_edit->LeftColumnClass ?>"><?php echo $model_gallery->model_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_gallery_edit->RightColumnClass ?>"><div<?php echo $model_gallery->model_id->CellAttributes() ?>>
...
<?php if ($model_gallery->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_model_gallery_image" class="<?php echo $model_gallery_edit->LeftColumnClass ?>"><?php echo $model_gallery->image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_gallery_edit->RightColumnClass ?>"><div<?php echo $model_gallery->image->CellAttributes() ?>>
...
<span title="<?php echo $model_gallery->image->FldTitle() ? $model_gallery->image->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($model_gallery->image->ReadOnly || $model_gallery->image->Disabled) echo " hide"; ?>" data-trigger="hover">
	...
	<input type="file" title=" " data-table="model_gallery" data-field="x_image" name="x_image" id="x_image"<?php echo $model_gallery->image->EditAttributes() ?>>
</span>
...
<?php if ($model_gallery->img_order->Visible) { // img_order ?>
	<div id="r_img_order" class="form-group">
		<label id="elh_model_gallery_img_order" for="x_img_order" class="<?php echo $model_gallery_edit->LeftColumnClass ?>"><?php echo $model_gallery->img_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_gallery_edit->RightColumnClass ?>"><div<?php echo $model_gallery->img_order->CellAttributes() ?>>
...
<?php if ($model_gallery->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_model_gallery_status" for="x_status" class="<?php echo $model_gallery_edit->LeftColumnClass ?>"><?php echo $model_gallery->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_gallery_edit->RightColumnClass ?>"><div<?php echo $model_gallery->status->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $model_gallery_edit->OffsetColumnClass ?>"><!-- buttons offset -->
