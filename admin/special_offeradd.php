...
$special_offer_add = NULL; // Initialize page object first

class cspecial_offer_add extends cspecial_offer {
	...
	// Page object name
	var $PageObjName = 'special_offer_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "special_offerview.php")
	...
	function LoadDefaultValues() {
		...
		$this->title_small->CurrentValue = NULL;
		$this->title_small->OldValue = $this->title_small->CurrentValue;
	...
	function NewRow() {
		...
		$row['title_small'] = $this->title_small->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// title_small
		$this->title_small->SetDbValueDef($rsnew, $this->title_small->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($special_offer_add)) $special_offer_add = new cspecial_offer_add();

// Page init
$special_offer_add->Page_Init();

// Page main
$special_offer_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$special_offer_add->Page_Render();
?>
...
var CurrentForm = fspecial_offeradd = new ew_Form("fspecial_offeradd", "add");

// Validate form
fspecial_offeradd.Validate = function() {
...
fspecial_offeradd.Form_CustomValidate = 
...
fspecial_offeradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fspecial_offeradd.Lists["x_is_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fspecial_offeradd.Lists["x_is_active"].Options = <?php echo json_encode($special_offer_add->is_active->Options()) ?>;
...
<?php $special_offer_add->ShowPageHeader(); ?>
<?php
$special_offer_add->ShowMessage();
?>
<form name="fspecial_offeradd" id="fspecial_offeradd" class="<?php echo $special_offer_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($special_offer_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $special_offer_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="special_offer">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($special_offer_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($special_offer->title_small->Visible) { // title_small ?>
	<div id="r_title_small" class="form-group">
		<label id="elh_special_offer_title_small" for="x_title_small" class="<?php echo $special_offer_add->LeftColumnClass ?>"><?php echo $special_offer->title_small->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $special_offer_add->RightColumnClass ?>"><div<?php echo $special_offer->title_small->CellAttributes() ?>>
...
<?php if ($special_offer->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_special_offer_title" for="x_title" class="<?php echo $special_offer_add->LeftColumnClass ?>"><?php echo $special_offer->title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $special_offer_add->RightColumnClass ?>"><div<?php echo $special_offer->title->CellAttributes() ?>>
...
<?php if ($special_offer->url_slug->Visible) { // url_slug ?>
	<div id="r_url_slug" class="form-group">
		<label id="elh_special_offer_url_slug" for="x_url_slug" class="<?php echo $special_offer_add->LeftColumnClass ?>"><?php echo $special_offer->url_slug->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $special_offer_add->RightColumnClass ?>"><div<?php echo $special_offer->url_slug->CellAttributes() ?>>
...
<?php if ($special_offer->_thumbnail->Visible) { // thumbnail ?>
	<div id="r__thumbnail" class="form-group">
		<label id="elh_special_offer__thumbnail" class="<?php echo $special_offer_add->LeftColumnClass ?>"><?php echo $special_offer->_thumbnail->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $special_offer_add->RightColumnClass ?>"><div<?php echo $special_offer->_thumbnail->CellAttributes() ?>>
...
<?php if ($special_offer->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_special_offer_description" class="<?php echo $special_offer_add->LeftColumnClass ?>"><?php echo $special_offer->description->FldCaption() ?></label>
		<div class="<?php echo $special_offer_add->RightColumnClass ?>"><div<?php echo $special_offer->description->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fspecial_offeradd", "x_description", 50, 6, <?php echo ($special_offer->description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($special_offer->linkto->Visible) { // linkto ?>
	<div id="r_linkto" class="form-group">
		<label id="elh_special_offer_linkto" for="x_linkto" class="<?php echo $special_offer_add->LeftColumnClass ?>"><?php echo $special_offer->linkto->FldCaption() ?></label>
		<div class="<?php echo $special_offer_add->RightColumnClass ?>"><div<?php echo $special_offer->linkto->CellAttributes() ?>>
...
<?php if ($special_offer->is_active->Visible) { // is_active ?>
	<div id="r_is_active" class="form-group">
		<label id="elh_special_offer_is_active" class="<?php echo $special_offer_add->LeftColumnClass ?>"><?php echo $special_offer->is_active->FldCaption() ?></label>
		<div class="<?php echo $special_offer_add->RightColumnClass ?>"><div<?php echo $special_offer->is_active->CellAttributes() ?>>
...
<?php if (!$special_offer_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $special_offer_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $special_offer_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fspecial_offeradd.Init();
</script>
<?php
$special_offer_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$special_offer_add->Page_Terminate();
?>
