...
$form_request_add = NULL; // Initialize page object first

class cform_request_add extends cform_request {
	...
	// Page object name
	var $PageObjName = 'form_request_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["fr_id"] != "") {
				...
				$this->setKey("fr_id", $this->fr_id->CurrentValue); // Set up key
			} else {
				$this->setKey("fr_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "form_requestview.php")
	...
	function LoadDefaultValues() {
		...
		$this->fr_id->OldValue = $this->fr_id->CurrentValue;
		...
		$this->date_submit->CurrentValue = NULL;
		$this->date_submit->OldValue = $this->date_submit->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row = array();
		$row['fr_id'] = $this->fr_id->CurrentValue;
		...
		$row['date_submit'] = $this->date_submit->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// date_submit
		$this->date_submit->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_submit->CurrentValue, 0), NULL, FALSE);
...
// Create page object
if (!isset($form_request_add)) $form_request_add = new cform_request_add();

// Page init
$form_request_add->Page_Init();

// Page main
$form_request_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$form_request_add->Page_Render();
?>
...
var CurrentForm = fform_requestadd = new ew_Form("fform_requestadd", "add");

// Validate form
fform_requestadd.Validate = function() {
...
fform_requestadd.Form_CustomValidate = 
...
fform_requestadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $form_request_add->ShowPageHeader(); ?>
<?php
$form_request_add->ShowMessage();
?>
<form name="fform_requestadd" id="fform_requestadd" class="<?php echo $form_request_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($form_request_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $form_request_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="form_request">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($form_request_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($form_request->fullname->Visible) { // fullname ?>
	<div id="r_fullname" class="form-group">
		<label id="elh_form_request_fullname" for="x_fullname" class="<?php echo $form_request_add->LeftColumnClass ?>"><?php echo $form_request->fullname->FldCaption() ?></label>
		<div class="<?php echo $form_request_add->RightColumnClass ?>"><div<?php echo $form_request->fullname->CellAttributes() ?>>
...
<?php if ($form_request->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_form_request__email" for="x__email" class="<?php echo $form_request_add->LeftColumnClass ?>"><?php echo $form_request->_email->FldCaption() ?></label>
		<div class="<?php echo $form_request_add->RightColumnClass ?>"><div<?php echo $form_request->_email->CellAttributes() ?>>
...
<?php if ($form_request->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_form_request_phone" for="x_phone" class="<?php echo $form_request_add->LeftColumnClass ?>"><?php echo $form_request->phone->FldCaption() ?></label>
		<div class="<?php echo $form_request_add->RightColumnClass ?>"><div<?php echo $form_request->phone->CellAttributes() ?>>
...
<?php if ($form_request->model->Visible) { // model ?>
	<div id="r_model" class="form-group">
		<label id="elh_form_request_model" for="x_model" class="<?php echo $form_request_add->LeftColumnClass ?>"><?php echo $form_request->model->FldCaption() ?></label>
		<div class="<?php echo $form_request_add->RightColumnClass ?>"><div<?php echo $form_request->model->CellAttributes() ?>>
...
<?php if ($form_request->message->Visible) { // message ?>
	<div id="r_message" class="form-group">
		<label id="elh_form_request_message" for="x_message" class="<?php echo $form_request_add->LeftColumnClass ?>"><?php echo $form_request->message->FldCaption() ?></label>
		<div class="<?php echo $form_request_add->RightColumnClass ?>"><div<?php echo $form_request->message->CellAttributes() ?>>
...
<?php if ($form_request->date_submit->Visible) { // date_submit ?>
	<div id="r_date_submit" class="form-group">
		<label id="elh_form_request_date_submit" for="x_date_submit" class="<?php echo $form_request_add->LeftColumnClass ?>"><?php echo $form_request->date_submit->FldCaption() ?></label>
		<div class="<?php echo $form_request_add->RightColumnClass ?>"><div<?php echo $form_request->date_submit->CellAttributes() ?>>
...
<?php if (!$form_request_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $form_request_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $form_request_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fform_requestadd.Init();
</script>
<?php
$form_request_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$form_request_add->Page_Terminate();
?>
