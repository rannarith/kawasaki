...
$specification_view = NULL; // Initialize page object first

class cspecification_view extends cspecification {
	...
	// Page object name
	var $PageObjName = 'specification_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["spec_id"] <> "") {
			$this->RecKey["spec_id"] = $_GET["spec_id"];
			$KeyUrl .= "&amp;spec_id=" . urlencode($this->RecKey["spec_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["spec_id"] <> "") {
				...
				$this->RecKey["spec_id"] = $this->spec_id->QueryStringValue;
			} elseif (@$_POST["spec_id"] <> "") {
				$this->spec_id->setFormValue($_POST["spec_id"]);
				$this->RecKey["spec_id"] = $this->spec_id->FormValue;
			} else {
				$sReturnUrl = "specificationlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "specificationlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "specificationlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($specification_view)) $specification_view = new cspecification_view();

// Page init
$specification_view->Page_Init();

// Page main
$specification_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$specification_view->Page_Render();
?>
...
var CurrentForm = fspecificationview = new ew_Form("fspecificationview", "view");

// Form_CustomValidate event
fspecificationview.Form_CustomValidate = 
...
fspecificationview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fspecificationview.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"model"};
fspecificationview.Lists["x_model_id"].Data = "<?php echo $specification_view->model_id->LookupFilterQuery(FALSE, "view") ?>";
fspecificationview.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fspecificationview.Lists["x_status"].Options = <?php echo json_encode($specification_view->status->Options()) ?>;
...
<div class="ewToolbar">
<?php $specification_view->ExportOptions->Render("body") ?>
<?php
	foreach ($specification_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $specification_view->ShowPageHeader(); ?>
<?php
$specification_view->ShowMessage();
?>
<form name="fspecificationview" id="fspecificationview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($specification_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $specification_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="specification">
<input type="hidden" name="modal" value="<?php echo intval($specification_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($specification->spec_id->Visible) { // spec_id ?>
	<tr id="r_spec_id">
		<td class="col-sm-2"><span id="elh_specification_spec_id"><?php echo $specification->spec_id->FldCaption() ?></span></td>
...
<?php if ($specification->model_id->Visible) { // model_id ?>
	<tr id="r_model_id">
		<td class="col-sm-2"><span id="elh_specification_model_id"><?php echo $specification->model_id->FldCaption() ?></span></td>
...
<?php if ($specification->title->Visible) { // title ?>
	<tr id="r_title">
		<td class="col-sm-2"><span id="elh_specification_title"><?php echo $specification->title->FldCaption() ?></span></td>
...
<?php if ($specification->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_specification_description"><?php echo $specification->description->FldCaption() ?></span></td>
		<td data-name="description"<?php echo $specification->description->CellAttributes() ?>>
<span id="el_specification_description">
<span<?php echo $specification->description->ViewAttributes() ?>>
<?php echo $specification->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($specification->s_order->Visible) { // s_order ?>
	<tr id="r_s_order">
		<td class="col-sm-2"><span id="elh_specification_s_order"><?php echo $specification->s_order->FldCaption() ?></span></td>
...
<?php if ($specification->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_specification_status"><?php echo $specification->status->FldCaption() ?></span></td>
...
<script type="text/javascript">
fspecificationview.Init();
</script>
<?php
$specification_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$specification_view->Page_Terminate();
?>
