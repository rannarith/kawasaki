...
$model_color_add = NULL; // Initialize page object first

class cmodel_color_add extends cmodel_color {
	...
	// Page object name
	var $PageObjName = 'model_color_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["mc_id"] != "") {
				...
				$this->setKey("mc_id", $this->mc_id->CurrentValue); // Set up key
			} else {
				$this->setKey("mc_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "model_colorview.php")
	...
	function NewRow() {
		...
		$row = array();
		$row['mc_id'] = $this->mc_id->CurrentValue;
		$row['image'] = $this->image->Upload->DbValue;
		$row['model_id'] = $this->model_id->CurrentValue;
		$row['color_code'] = $this->color_code->CurrentValue;
		$row['m_order'] = $this->m_order->CurrentValue;
		$row['m_status'] = $this->m_status->CurrentValue;
		return $row;
	}
...
// Create page object
if (!isset($model_color_add)) $model_color_add = new cmodel_color_add();

// Page init
$model_color_add->Page_Init();

// Page main
$model_color_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$model_color_add->Page_Render();
?>
...
var CurrentForm = fmodel_coloradd = new ew_Form("fmodel_coloradd", "add");

// Validate form
fmodel_coloradd.Validate = function() {
...
fmodel_coloradd.Form_CustomValidate = 
...
fmodel_coloradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmodel_coloradd.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"model"};
fmodel_coloradd.Lists["x_model_id"].Data = "<?php echo $model_color_add->model_id->LookupFilterQuery(FALSE, "add") ?>";
fmodel_coloradd.Lists["x_m_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmodel_coloradd.Lists["x_m_status"].Options = <?php echo json_encode($model_color_add->m_status->Options()) ?>;
...
<?php $model_color_add->ShowPageHeader(); ?>
<?php
$model_color_add->ShowMessage();
?>
<form name="fmodel_coloradd" id="fmodel_coloradd" class="<?php echo $model_color_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($model_color_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $model_color_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="model_color">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($model_color_add->IsModal) ?>">
...
<?php if ($model_color->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_model_color_image" class="<?php echo $model_color_add->LeftColumnClass ?>"><?php echo $model_color->image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_color_add->RightColumnClass ?>"><div<?php echo $model_color->image->CellAttributes() ?>>
...
<?php if ($model_color->model_id->Visible) { // model_id ?>
	<div id="r_model_id" class="form-group">
		<label id="elh_model_color_model_id" for="x_model_id" class="<?php echo $model_color_add->LeftColumnClass ?>"><?php echo $model_color->model_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_color_add->RightColumnClass ?>"><div<?php echo $model_color->model_id->CellAttributes() ?>>
...
<?php if ($model_color->color_code->Visible) { // color_code ?>
	<div id="r_color_code" class="form-group">
		<label id="elh_model_color_color_code" for="x_color_code" class="<?php echo $model_color_add->LeftColumnClass ?>"><?php echo $model_color->color_code->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_color_add->RightColumnClass ?>"><div<?php echo $model_color->color_code->CellAttributes() ?>>
...
<?php if ($model_color->m_order->Visible) { // m_order ?>
	<div id="r_m_order" class="form-group">
		<label id="elh_model_color_m_order" for="x_m_order" class="<?php echo $model_color_add->LeftColumnClass ?>"><?php echo $model_color->m_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_color_add->RightColumnClass ?>"><div<?php echo $model_color->m_order->CellAttributes() ?>>
...
<?php if ($model_color->m_status->Visible) { // m_status ?>
	<div id="r_m_status" class="form-group">
		<label id="elh_model_color_m_status" for="x_m_status" class="<?php echo $model_color_add->LeftColumnClass ?>"><?php echo $model_color->m_status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_color_add->RightColumnClass ?>"><div<?php echo $model_color->m_status->CellAttributes() ?>>
...
<?php if (!$model_color_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $model_color_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $model_color_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fmodel_coloradd.Init();
</script>
<?php
$model_color_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$model_color_add->Page_Terminate();
?>
