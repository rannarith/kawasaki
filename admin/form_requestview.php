	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["fr_id"] <> "") {
				...
				$this->fr_id->setFormValue($_POST["fr_id"]);
				$this->RecKey["fr_id"] = $this->fr_id->FormValue;
			} else {
...
var CurrentForm = fform_requestview = new ew_Form("fform_requestview", "view");
...
fform_requestview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $form_request_view->ExportOptions->Render("body") ?>
<?php
	foreach ($form_request_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fform_requestview" id="fform_requestview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($form_request_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $form_request_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="form_request">
<input type="hidden" name="modal" value="<?php echo intval($form_request_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($form_request->fr_id->Visible) { // fr_id ?>
	<tr id="r_fr_id">
		<td class="col-sm-2"><span id="elh_form_request_fr_id"><?php echo $form_request->fr_id->FldCaption() ?></span></td>
...
<?php if ($form_request->fullname->Visible) { // fullname ?>
	<tr id="r_fullname">
		<td class="col-sm-2"><span id="elh_form_request_fullname"><?php echo $form_request->fullname->FldCaption() ?></span></td>
...
<?php if ($form_request->_email->Visible) { // email ?>
	<tr id="r__email">
		<td class="col-sm-2"><span id="elh_form_request__email"><?php echo $form_request->_email->FldCaption() ?></span></td>
...
<?php if ($form_request->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td class="col-sm-2"><span id="elh_form_request_phone"><?php echo $form_request->phone->FldCaption() ?></span></td>
...
<?php if ($form_request->model->Visible) { // model ?>
	<tr id="r_model">
		<td class="col-sm-2"><span id="elh_form_request_model"><?php echo $form_request->model->FldCaption() ?></span></td>
...
<?php if ($form_request->message->Visible) { // message ?>
	<tr id="r_message">
		<td class="col-sm-2"><span id="elh_form_request_message"><?php echo $form_request->message->FldCaption() ?></span></td>
		<td data-name="message"<?php echo $form_request->message->CellAttributes() ?>>
...
<?php if ($form_request->date_submit->Visible) { // date_submit ?>
	<tr id="r_date_submit">
		<td class="col-sm-2"><span id="elh_form_request_date_submit"><?php echo $form_request->date_submit->FldCaption() ?></span></td>
