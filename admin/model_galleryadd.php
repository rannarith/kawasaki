...
class cmodel_gallery_add extends cmodel_gallery {
	...
	function LoadDefaultValues() {
		...
		$this->gallery_id->OldValue = $this->gallery_id->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['gallery_id'] = $this->gallery_id->CurrentValue;
		$row['model_id'] = $this->model_id->CurrentValue;
		$row['image'] = $this->image->Upload->DbValue;
		$row['img_order'] = $this->img_order->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		if (strval($this->model_id->CurrentValue) <> "") {
			$sMasterFilter = str_replace("@model_id@", ew_AdjustSql($this->model_id->CurrentValue, "DB"), $sMasterFilter);
		} else {
...
fmodel_galleryadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
fmodel_galleryadd.Lists["x_model_id"].Data = "<?php echo $model_gallery_add->model_id->LookupFilterQuery(FALSE, "add") ?>";
...
fmodel_galleryadd.Lists["x_status"].Options = <?php echo json_encode($model_gallery_add->status->Options()) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($model_gallery_add->IsModal) ?>">
...
<?php if ($model_gallery->model_id->Visible) { // model_id ?>
	<div id="r_model_id" class="form-group">
		<label id="elh_model_gallery_model_id" for="x_model_id" class="<?php echo $model_gallery_add->LeftColumnClass ?>"><?php echo $model_gallery->model_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_gallery_add->RightColumnClass ?>"><div<?php echo $model_gallery->model_id->CellAttributes() ?>>
...
<?php if ($model_gallery->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_model_gallery_image" class="<?php echo $model_gallery_add->LeftColumnClass ?>"><?php echo $model_gallery->image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_gallery_add->RightColumnClass ?>"><div<?php echo $model_gallery->image->CellAttributes() ?>>
...
<?php if ($model_gallery->img_order->Visible) { // img_order ?>
	<div id="r_img_order" class="form-group">
		<label id="elh_model_gallery_img_order" for="x_img_order" class="<?php echo $model_gallery_add->LeftColumnClass ?>"><?php echo $model_gallery->img_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_gallery_add->RightColumnClass ?>"><div<?php echo $model_gallery->img_order->CellAttributes() ?>>
...
<?php if ($model_gallery->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_model_gallery_status" for="x_status" class="<?php echo $model_gallery_add->LeftColumnClass ?>"><?php echo $model_gallery->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $model_gallery_add->RightColumnClass ?>"><div<?php echo $model_gallery->status->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $model_gallery_add->OffsetColumnClass ?>"><!-- buttons offset -->
