	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["cid"] <> "") {
				...
				$this->cid->setFormValue($_POST["cid"]);
				$this->RecKey["cid"] = $this->cid->FormValue;
			} else {
...
var CurrentForm = fcareerview = new ew_Form("fcareerview", "view");
...
fcareerview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcareerview.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcareerview.Lists["x_status"].Options = <?php echo json_encode($career_view->status->Options()) ?>;
...
<div class="ewToolbar">
<?php $career_view->ExportOptions->Render("body") ?>
<?php
	foreach ($career_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fcareerview" id="fcareerview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($career_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $career_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="career">
<input type="hidden" name="modal" value="<?php echo intval($career_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($career->cid->Visible) { // cid ?>
	<tr id="r_cid">
		<td class="col-sm-2"><span id="elh_career_cid"><?php echo $career->cid->FldCaption() ?></span></td>
...
<?php if ($career->position->Visible) { // position ?>
	<tr id="r_position">
		<td class="col-sm-2"><span id="elh_career_position"><?php echo $career->position->FldCaption() ?></span></td>
...
<?php if ($career->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_career_description"><?php echo $career->description->FldCaption() ?></span></td>
		<td data-name="description"<?php echo $career->description->CellAttributes() ?>>
...
<?php if ($career->create_date->Visible) { // create_date ?>
	<tr id="r_create_date">
		<td class="col-sm-2"><span id="elh_career_create_date"><?php echo $career->create_date->FldCaption() ?></span></td>
...
<?php if ($career->closing_date->Visible) { // closing_date ?>
	<tr id="r_closing_date">
		<td class="col-sm-2"><span id="elh_career_closing_date"><?php echo $career->closing_date->FldCaption() ?></span></td>
...
<?php if ($career->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_career_status"><?php echo $career->status->FldCaption() ?></span></td>
