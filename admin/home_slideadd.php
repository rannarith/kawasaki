...
class chome_slide_add extends chome_slide {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "home_slideview.php")
	...
	function NewRow() {
		...
		$row['s_order'] = $this->s_order->CurrentValue;
...
var CurrentForm = fhome_slideadd = new ew_Form("fhome_slideadd", "add");

// Validate form
fhome_slideadd.Validate = function() {
...
fhome_slideadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fhome_slideadd.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhome_slideadd.Lists["x_status"].Options = <?php echo json_encode($home_slide_add->status->Options()) ?>;
...
?>
<form name="fhome_slideadd" id="fhome_slideadd" class="<?php echo $home_slide_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($home_slide_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $home_slide_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="home_slide">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($home_slide_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($home_slide->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_home_slide_name" for="x_name" class="<?php echo $home_slide_add->LeftColumnClass ?>"><?php echo $home_slide->name->FldCaption() ?></label>
		<div class="<?php echo $home_slide_add->RightColumnClass ?>"><div<?php echo $home_slide->name->CellAttributes() ?>>
...
<?php if ($home_slide->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_home_slide_image" class="<?php echo $home_slide_add->LeftColumnClass ?>"><?php echo $home_slide->image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $home_slide_add->RightColumnClass ?>"><div<?php echo $home_slide->image->CellAttributes() ?>>
...
<?php if ($home_slide->linkto->Visible) { // linkto ?>
	<div id="r_linkto" class="form-group">
		<label id="elh_home_slide_linkto" for="x_linkto" class="<?php echo $home_slide_add->LeftColumnClass ?>"><?php echo $home_slide->linkto->FldCaption() ?></label>
		<div class="<?php echo $home_slide_add->RightColumnClass ?>"><div<?php echo $home_slide->linkto->CellAttributes() ?>>
...
<?php if ($home_slide->s_order->Visible) { // s_order ?>
	<div id="r_s_order" class="form-group">
		<label id="elh_home_slide_s_order" for="x_s_order" class="<?php echo $home_slide_add->LeftColumnClass ?>"><?php echo $home_slide->s_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $home_slide_add->RightColumnClass ?>"><div<?php echo $home_slide->s_order->CellAttributes() ?>>
...
<?php if ($home_slide->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_home_slide_status" for="x_status" class="<?php echo $home_slide_add->LeftColumnClass ?>"><?php echo $home_slide->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $home_slide_add->RightColumnClass ?>"><div<?php echo $home_slide->status->CellAttributes() ?>>
...
<?php if (!$home_slide_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $home_slide_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $home_slide_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
