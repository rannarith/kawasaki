...
ffeatureview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ffeatureview.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"model"};
ffeatureview.Lists["x_model_id"].Data = "<?php echo $feature_view->model_id->LookupFilterQuery(FALSE, "view") ?>";
...
<input type="hidden" name="modal" value="<?php echo intval($feature_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($feature->feature_id->Visible) { // feature_id ?>
	<tr id="r_feature_id">
		<td class="col-sm-2"><span id="elh_feature_feature_id"><?php echo $feature->feature_id->FldCaption() ?></span></td>
...
<?php if ($feature->top_title->Visible) { // top_title ?>
	<tr id="r_top_title">
		<td class="col-sm-2"><span id="elh_feature_top_title"><?php echo $feature->top_title->FldCaption() ?></span></td>
...
<?php if ($feature->title->Visible) { // title ?>
	<tr id="r_title">
		<td class="col-sm-2"><span id="elh_feature_title"><?php echo $feature->title->FldCaption() ?></span></td>
...
<?php if ($feature->model_id->Visible) { // model_id ?>
	<tr id="r_model_id">
		<td class="col-sm-2"><span id="elh_feature_model_id"><?php echo $feature->model_id->FldCaption() ?></span></td>
...
<?php if ($feature->_thumbnail->Visible) { // thumbnail ?>
	<tr id="r__thumbnail">
		<td class="col-sm-2"><span id="elh_feature__thumbnail"><?php echo $feature->_thumbnail->FldCaption() ?></span></td>
		<td data-name="_thumbnail"<?php echo $feature->_thumbnail->CellAttributes() ?>>
<span id="el_feature__thumbnail">
<span>
<?php echo ew_GetFileViewTag($feature->_thumbnail, $feature->_thumbnail->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($feature->long_des->Visible) { // long_des ?>
	<tr id="r_long_des">
		<td class="col-sm-2"><span id="elh_feature_long_des"><?php echo $feature->long_des->FldCaption() ?></span></td>
...
<?php if ($feature->f_order->Visible) { // f_order ?>
	<tr id="r_f_order">
		<td class="col-sm-2"><span id="elh_feature_f_order"><?php echo $feature->f_order->FldCaption() ?></span></td>
