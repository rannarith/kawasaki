...
class cnews_edit extends cnews {
	...
	function ValidateForm() {
		...
		if (in_array("news_gallery", $DetailTblVar) && $GLOBALS["news_gallery"]->DetailEdit) {
...
fnewsedit.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnewsedit.Lists["x_status"].Options = <?php echo json_encode($news_edit->status->Options()) ?>;
...
<?php if ($news->news_id->Visible) { // news_id ?>
	<div id="r_news_id" class="form-group">
		<label id="elh_news_news_id" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->news_id->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->news_id->CellAttributes() ?>>
...
<?php if ($news->_thumbnail->Visible) { // thumbnail ?>
	<div id="r__thumbnail" class="form-group">
		<label id="elh_news__thumbnail" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->_thumbnail->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->_thumbnail->CellAttributes() ?>>
...
<?php if ($news->url_slug->Visible) { // url_slug ?>
	<div id="r_url_slug" class="form-group">
		<label id="elh_news_url_slug" for="x_url_slug" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->url_slug->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->url_slug->CellAttributes() ?>>
...
<?php if ($news->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_news_title" for="x_title" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($news->short_des->Visible) { // short_des ?>
	<div id="r_short_des" class="form-group">
		<label id="elh_news_short_des" for="x_short_des" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->short_des->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->short_des->CellAttributes() ?>>
...
<?php if ($news->long_des->Visible) { // long_des ?>
	<div id="r_long_des" class="form-group">
		<label id="elh_news_long_des" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->long_des->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->long_des->CellAttributes() ?>>
...
<?php if ($news->youtube_url->Visible) { // youtube_url ?>
	<div id="r_youtube_url" class="form-group">
		<label id="elh_news_youtube_url" for="x_youtube_url" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->youtube_url->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->youtube_url->CellAttributes() ?>>
...
<?php if ($news->news_date->Visible) { // news_date ?>
	<div id="r_news_date" class="form-group">
		<label id="elh_news_news_date" for="x_news_date" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->news_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->news_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fnewsedit", "x_news_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($news->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_news_status" for="x_status" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->status->CellAttributes() ?>>
...
<?php
	if (in_array("news_gallery", explode(",", $news->getCurrentDetailTable())) && $news_gallery->DetailEdit) {
?>
