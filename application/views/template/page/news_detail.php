...
<div class="container">  
    <div class="row">
        ...
        <div class="col-lg-12 text-center" >
            <?php
            if ($news_info->num_rows() > 0) {
                $row = $news_info->row();
                ?>
                <div class="clear"></div><br/><br/>
                <h4  class="promotion_title kawa_txt_color"><?php echo $row->title; ?></h4>
                <i>Date : <?php echo $row->news_date; ?></i>
            ...
            <div class="clear"></div> 
            Share On Social Media
            <a href="http://www.facebook.com/sharer.php?u=<?php echo base_url() . 'page/news_detail/' . $this->uri->segment(3); ?>" target="_blank">
                <img src="<?php echo base_url() . 'images/fb.png'; ?>" alt="kawasaki social link" style="width: 40px;"/>
            </a>
            <a href="https://plus.google.com/share?url=<?php echo base_url() . 'page/news_detail/' . $this->uri->segment(3); ?>"  target="_blank">
        ...
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div id="jssor_2" style="position:relative;margin:0 auto;top:0px;left:0px;width:1300px;height:846px;overflow:hidden;visibility:hidden;">
                ...
                <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:846px;overflow:hidden;">
                    <?php
                    foreach ($news_gallery->result() as $row) {
                        ?>

                        <div>
                            <img data-u="image" src="<?php echo base_url() . 'assets/images/news_gallery/' . $row->image; ?>" />
                        </div>
                        <?php
                    }
                    ?>
