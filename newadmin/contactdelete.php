...
<?php if ($contact->contact_id->Visible) { // contact_id ?>
		<th><span id="elh_contact_contact_id" class="contact_contact_id"><?php echo $contact->contact_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($contact->full_name->Visible) { // full_name ?>
		<th><span id="elh_contact_full_name" class="contact_full_name"><?php echo $contact->full_name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($contact->_email->Visible) { // email ?>
		<th><span id="elh_contact__email" class="contact__email"><?php echo $contact->_email->FldCaption() ?></span></th>
<?php } ?>
<?php if ($contact->send_date->Visible) { // send_date ?>
		<th><span id="elh_contact_send_date" class="contact_send_date"><?php echo $contact->send_date->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
