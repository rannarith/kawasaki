...
class cmodel_list extends cmodel {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = $UserProfile->GetSearchFilters(CurrentUserName(), "fmodellistsrch");
		} else {
			$sSavedFilterList = "";
		}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->model_id->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fmodellistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
	...
	function RenderRow() {
		...
		$this->status->ViewCustomAttributes = "";
			...
			if ($this->icon_menu->UseColorbox) {
				...
				$this->icon_menu->LinkAttrs["data-rel"] = "model_x" . $this->RowCnt . "_icon_menu";
...
fmodellist.Lists["x_status"].Options = <?php echo json_encode($model->status->Options()) ?>;
...
<form name="fmodellistsrch" id="fmodellistsrch" class="form-inline ewForm" action="<?php echo ew_CurrentPage() ?>">
...
<div class="panel panel-default ewGrid model">
...
<?php } ?>
<input type="hidden" name="t" value="model">
<div id="gmp_model" class="<?php if (ew_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($model->model_id->Visible) { // model_id ?>
	<?php if ($model->SortUrl($model->model_id) == "") { ?>
		<th data-name="model_id"><div id="elh_model_model_id" class="model_model_id"><div class="ewTableHeaderCaption"><?php echo $model->model_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="model_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->model_id) ?>',1);"><div id="elh_model_model_id" class="model_model_id">
...
<?php if ($model->model_name->Visible) { // model_name ?>
	<?php if ($model->SortUrl($model->model_name) == "") { ?>
		<th data-name="model_name"><div id="elh_model_model_name" class="model_model_name"><div class="ewTableHeaderCaption"><?php echo $model->model_name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="model_name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->model_name) ?>',1);"><div id="elh_model_model_name" class="model_model_name">
...
<?php if ($model->model_year->Visible) { // model_year ?>
	<?php if ($model->SortUrl($model->model_year) == "") { ?>
		<th data-name="model_year"><div id="elh_model_model_year" class="model_model_year"><div class="ewTableHeaderCaption"><?php echo $model->model_year->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="model_year"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->model_year) ?>',1);"><div id="elh_model_model_year" class="model_model_year">
...
<?php if ($model->icon_menu->Visible) { // icon_menu ?>
	<?php if ($model->SortUrl($model->icon_menu) == "") { ?>
		<th data-name="icon_menu"><div id="elh_model_icon_menu" class="model_icon_menu"><div class="ewTableHeaderCaption"><?php echo $model->icon_menu->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="icon_menu"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->icon_menu) ?>',1);"><div id="elh_model_icon_menu" class="model_icon_menu">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $model->icon_menu->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($model->icon_menu->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($model->icon_menu->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($model->_thumbnail->Visible) { // thumbnail ?>
	<?php if ($model->SortUrl($model->_thumbnail) == "") { ?>
		<th data-name="_thumbnail"><div id="elh_model__thumbnail" class="model__thumbnail"><div class="ewTableHeaderCaption"><?php echo $model->_thumbnail->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_thumbnail"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->_thumbnail) ?>',1);"><div id="elh_model__thumbnail" class="model__thumbnail">
...
<?php if ($model->youtube_url->Visible) { // youtube_url ?>
	<?php if ($model->SortUrl($model->youtube_url) == "") { ?>
		<th data-name="youtube_url"><div id="elh_model_youtube_url" class="model_youtube_url"><div class="ewTableHeaderCaption"><?php echo $model->youtube_url->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="youtube_url"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->youtube_url) ?>',1);"><div id="elh_model_youtube_url" class="model_youtube_url">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $model->youtube_url->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($model->youtube_url->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($model->youtube_url->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($model->category_id->Visible) { // category_id ?>
	<?php if ($model->SortUrl($model->category_id) == "") { ?>
		<th data-name="category_id"><div id="elh_model_category_id" class="model_category_id"><div class="ewTableHeaderCaption"><?php echo $model->category_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="category_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->category_id) ?>',1);"><div id="elh_model_category_id" class="model_category_id">
...
<?php if ($model->m_order->Visible) { // m_order ?>
	<?php if ($model->SortUrl($model->m_order) == "") { ?>
		<th data-name="m_order"><div id="elh_model_m_order" class="model_m_order"><div class="ewTableHeaderCaption"><?php echo $model->m_order->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="m_order"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->m_order) ?>',1);"><div id="elh_model_m_order" class="model_m_order">
...
<?php if ($model->status->Visible) { // status ?>
	<?php if ($model->SortUrl($model->status) == "") { ?>
		<th data-name="status"><div id="elh_model_status" class="model_status"><div class="ewTableHeaderCaption"><?php echo $model->status->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="status"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->status) ?>',1);"><div id="elh_model_status" class="model_status">
...
<a id="<?php echo $model_list->PageObjName . "_row_" . $model_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($model->model_name->Visible) { // model_name ?>
...
<span id="el<?php echo $model_list->RowCnt ?>_model_icon_menu" class="model_icon_menu">
<span>
<?php echo ew_GetFileViewTag($model->icon_menu, $model->icon_menu->ListViewValue()) ?>
</span>
</span>
</td>
	<?php } ?>
...
<span id="el<?php echo $model_list->RowCnt ?>_model_youtube_url" class="model_youtube_url">
