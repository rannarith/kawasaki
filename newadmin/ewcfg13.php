...
define("EW_PROJECT_NAME", "kawa", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{BE8C113E-D6C5-4712-BA29-D5C99D7D07A2}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'ApjksDuA6fkpmovj', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/kawa.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "kawasaki2", "qs" => "`", "qe" => "`");
...
define("EW_UPLOAD_DEST_PATH", "../assets/images/", TRUE); // Upload destination path (relative to app root)
