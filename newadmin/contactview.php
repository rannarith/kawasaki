...
<?php if ($contact->contact_id->Visible) { // contact_id ?>
	<tr id="r_contact_id">
		<td><span id="elh_contact_contact_id"><?php echo $contact->contact_id->FldCaption() ?></span></td>
...
<?php if ($contact->full_name->Visible) { // full_name ?>
	<tr id="r_full_name">
		<td><span id="elh_contact_full_name"><?php echo $contact->full_name->FldCaption() ?></span></td>
...
<?php if ($contact->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_contact__email"><?php echo $contact->_email->FldCaption() ?></span></td>
...
<?php if ($contact->message->Visible) { // message ?>
	<tr id="r_message">
		<td><span id="elh_contact_message"><?php echo $contact->message->FldCaption() ?></span></td>
...
<?php if ($contact->send_date->Visible) { // send_date ?>
	<tr id="r_send_date">
		<td><span id="elh_contact_send_date"><?php echo $contact->send_date->FldCaption() ?></span></td>
