...
fmodel_categoryedit.Lists["x_status"].Options = <?php echo json_encode($model_category->status->Options()) ?>;
...
<?php if ($model_category->category_id->Visible) { // category_id ?>
	<div id="r_category_id" class="form-group">
		<label id="elh_model_category_category_id" class="col-sm-2 control-label ewLabel"><?php echo $model_category->category_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $model_category->category_id->CellAttributes() ?>>
