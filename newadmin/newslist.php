...
class cnews_list extends cnews {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = $UserProfile->GetSearchFilters(CurrentUserName(), "fnewslistsrch");
		} else {
			$sSavedFilterList = "";
		}
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fnewslistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
...
<form name="fnewslistsrch" id="fnewslistsrch" class="form-inline ewForm" action="<?php echo ew_CurrentPage() ?>">
...
<div class="panel panel-default ewGrid news">
...
<?php if ($news->_thumbnail->Visible) { // thumbnail ?>
	<?php if ($news->SortUrl($news->_thumbnail) == "") { ?>
		<th data-name="_thumbnail"><div id="elh_news__thumbnail" class="news__thumbnail"><div class="ewTableHeaderCaption"><?php echo $news->_thumbnail->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_thumbnail"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->_thumbnail) ?>',1);"><div id="elh_news__thumbnail" class="news__thumbnail">
...
<?php if ($news->title->Visible) { // title ?>
	<?php if ($news->SortUrl($news->title) == "") { ?>
		<th data-name="title"><div id="elh_news_title" class="news_title"><div class="ewTableHeaderCaption"><?php echo $news->title->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="title"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->title) ?>',1);"><div id="elh_news_title" class="news_title">
...
<?php if ($news->youtube_url->Visible) { // youtube_url ?>
	<?php if ($news->SortUrl($news->youtube_url) == "") { ?>
		<th data-name="youtube_url"><div id="elh_news_youtube_url" class="news_youtube_url"><div class="ewTableHeaderCaption"><?php echo $news->youtube_url->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="youtube_url"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->youtube_url) ?>',1);"><div id="elh_news_youtube_url" class="news_youtube_url">
...
<?php if ($news->status->Visible) { // status ?>
	<?php if ($news->SortUrl($news->status) == "") { ?>
		<th data-name="status"><div id="elh_news_status" class="news_status"><div class="ewTableHeaderCaption"><?php echo $news->status->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="status"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->status) ?>',1);"><div id="elh_news_status" class="news_status">
...
<span<?php echo $news->_thumbnail->ViewAttributes() ?>>
<?php echo $news->_thumbnail->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($news->title->Visible) { // title ?>
