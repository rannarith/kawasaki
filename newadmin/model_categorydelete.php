...
fmodel_categorydelete.Lists["x_status"].Options = <?php echo json_encode($model_category->status->Options()) ?>;
...
<?php if ($model_category->category_id->Visible) { // category_id ?>
		<th><span id="elh_model_category_category_id" class="model_category_category_id"><?php echo $model_category->category_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_category->category_name->Visible) { // category_name ?>
		<th><span id="elh_model_category_category_name" class="model_category_category_name"><?php echo $model_category->category_name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_category->status->Visible) { // status ?>
		<th><span id="elh_model_category_status" class="model_category_status"><?php echo $model_category->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
