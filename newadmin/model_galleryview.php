...
fmodel_galleryview.Lists["x_status"].Options = <?php echo json_encode($model_gallery->status->Options()) ?>;
...
<div class="ewToolbar">
<?php if (!$model_gallery_view->IsModal) { ?>
...
<?php if ($model_gallery->gallery_id->Visible) { // gallery_id ?>
	<tr id="r_gallery_id">
		<td><span id="elh_model_gallery_gallery_id"><?php echo $model_gallery->gallery_id->FldCaption() ?></span></td>
...
<?php if ($model_gallery->model_id->Visible) { // model_id ?>
	<tr id="r_model_id">
		<td><span id="elh_model_gallery_model_id"><?php echo $model_gallery->model_id->FldCaption() ?></span></td>
...
<?php if ($model_gallery->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_model_gallery_image"><?php echo $model_gallery->image->FldCaption() ?></span></td>
...
<?php if ($model_gallery->img_order->Visible) { // img_order ?>
	<tr id="r_img_order">
		<td><span id="elh_model_gallery_img_order"><?php echo $model_gallery->img_order->FldCaption() ?></span></td>
...
<?php if ($model_gallery->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_model_gallery_status"><?php echo $model_gallery->status->FldCaption() ?></span></td>
