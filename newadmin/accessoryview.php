...
faccessoryview.Lists["x_status"].Options = <?php echo json_encode($accessory->status->Options()) ?>;
...
<?php if ($accessory->acs_id->Visible) { // acs_id ?>
	<tr id="r_acs_id">
		<td><span id="elh_accessory_acs_id"><?php echo $accessory->acs_id->FldCaption() ?></span></td>
...
<?php if ($accessory->title->Visible) { // title ?>
	<tr id="r_title">
		<td><span id="elh_accessory_title"><?php echo $accessory->title->FldCaption() ?></span></td>
...
<?php if ($accessory->_thumbnail->Visible) { // thumbnail ?>
	<tr id="r__thumbnail">
		<td><span id="elh_accessory__thumbnail"><?php echo $accessory->_thumbnail->FldCaption() ?></span></td>
...
<?php if ($accessory->short_des->Visible) { // short_des ?>
	<tr id="r_short_des">
		<td><span id="elh_accessory_short_des"><?php echo $accessory->short_des->FldCaption() ?></span></td>
...
<?php if ($accessory->long_des->Visible) { // long_des ?>
	<tr id="r_long_des">
		<td><span id="elh_accessory_long_des"><?php echo $accessory->long_des->FldCaption() ?></span></td>
...
<?php if ($accessory->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_accessory_status"><?php echo $accessory->status->FldCaption() ?></span></td>
