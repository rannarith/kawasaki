	...
	function DeleteRows() {
		...
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				@unlink(ew_UploadPathEx(TRUE, $this->icon_menu->OldUploadPath) . $row['icon_menu']);
				$this->_thumbnail->OldUploadPath = '../assets/images/model/';
				@unlink(ew_UploadPathEx(TRUE, $this->_thumbnail->OldUploadPath) . $row['thumbnail']);
				$conn->raiseErrorFn = $GLOBALS["EW_ERROR_FN"];
...
fmodeldelete.Lists["x_status"].Options = <?php echo json_encode($model->status->Options()) ?>;
...
<?php if ($model->model_id->Visible) { // model_id ?>
		<th><span id="elh_model_model_id" class="model_model_id"><?php echo $model->model_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model->model_name->Visible) { // model_name ?>
		<th><span id="elh_model_model_name" class="model_model_name"><?php echo $model->model_name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model->model_year->Visible) { // model_year ?>
		<th><span id="elh_model_model_year" class="model_model_year"><?php echo $model->model_year->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model->icon_menu->Visible) { // icon_menu ?>
		<th><span id="elh_model_icon_menu" class="model_icon_menu"><?php echo $model->icon_menu->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model->_thumbnail->Visible) { // thumbnail ?>
		<th><span id="elh_model__thumbnail" class="model__thumbnail"><?php echo $model->_thumbnail->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model->youtube_url->Visible) { // youtube_url ?>
		<th><span id="elh_model_youtube_url" class="model_youtube_url"><?php echo $model->youtube_url->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model->category_id->Visible) { // category_id ?>
		<th><span id="elh_model_category_id" class="model_category_id"><?php echo $model->category_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model->m_order->Visible) { // m_order ?>
		<th><span id="elh_model_m_order" class="model_m_order"><?php echo $model->m_order->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model->status->Visible) { // status ?>
		<th><span id="elh_model_status" class="model_status"><?php echo $model->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($model->icon_menu->Visible) { // icon_menu ?>
		<td<?php echo $model->icon_menu->CellAttributes() ?>>
<span id="el<?php echo $model_delete->RowCnt ?>_model_icon_menu" class="model_icon_menu">
<span>
...
<?php } ?>
<?php if ($model->youtube_url->Visible) { // youtube_url ?>
		<td<?php echo $model->youtube_url->CellAttributes() ?>>
<span id="el<?php echo $model_delete->RowCnt ?>_model_youtube_url" class="model_youtube_url">
