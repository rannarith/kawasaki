...
class cfeature_view extends cfeature {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["feature_id"] <> "") {
				$this->feature_id->setFormValue($_POST["feature_id"]);
				$this->RecKey["feature_id"] = $this->feature_id->FormValue;
			} else {
...
var CurrentForm = ffeatureview = new ew_Form("ffeatureview", "view");
...
<div class="ewToolbar">
<?php if (!$feature_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $feature_view->ExportOptions->Render("body") ?>
<?php
	foreach ($feature_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$feature_view->IsModal) { ?>
...
?>
<form name="ffeatureview" id="ffeatureview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($feature_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $feature_view->Token ?>">
<?php } ?>
...
<?php if ($feature->feature_id->Visible) { // feature_id ?>
	<tr id="r_feature_id">
		<td><span id="elh_feature_feature_id"><?php echo $feature->feature_id->FldCaption() ?></span></td>
...
<?php if ($feature->title->Visible) { // title ?>
	<tr id="r_title">
		<td><span id="elh_feature_title"><?php echo $feature->title->FldCaption() ?></span></td>
...
<?php if ($feature->model_id->Visible) { // model_id ?>
	<tr id="r_model_id">
		<td><span id="elh_feature_model_id"><?php echo $feature->model_id->FldCaption() ?></span></td>
...
<?php if ($feature->_thumbnail->Visible) { // thumbnail ?>
	<tr id="r__thumbnail">
		<td><span id="elh_feature__thumbnail"><?php echo $feature->_thumbnail->FldCaption() ?></span></td>
...
<?php echo $feature->_thumbnail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($feature->long_des->Visible) { // long_des ?>
	<tr id="r_long_des">
		<td><span id="elh_feature_long_des"><?php echo $feature->long_des->FldCaption() ?></span></td>
		<td data-name="long_des"<?php echo $feature->long_des->CellAttributes() ?>>
...
<?php if ($feature->f_order->Visible) { // f_order ?>
	<tr id="r_f_order">
		<td><span id="elh_feature_f_order"><?php echo $feature->f_order->FldCaption() ?></span></td>
