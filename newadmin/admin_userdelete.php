	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("admin_userlist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fadmin_userdelete = new ew_Form("fadmin_userdelete", "delete");
...
?>
<form name="fadmin_userdelete" id="fadmin_userdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($admin_user_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $admin_user_delete->Token ?>">
<?php } ?>
...
<?php if ($admin_user->_userid->Visible) { // userid ?>
		<th><span id="elh_admin_user__userid" class="admin_user__userid"><?php echo $admin_user->_userid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($admin_user->username->Visible) { // username ?>
		<th><span id="elh_admin_user_username" class="admin_user_username"><?php echo $admin_user->username->FldCaption() ?></span></th>
<?php } ?>
<?php if ($admin_user->password->Visible) { // password ?>
		<th><span id="elh_admin_user_password" class="admin_user_password"><?php echo $admin_user->password->FldCaption() ?></span></th>
<?php } ?>
<?php if ($admin_user->_email->Visible) { // email ?>
		<th><span id="elh_admin_user__email" class="admin_user__email"><?php echo $admin_user->_email->FldCaption() ?></span></th>
<?php } ?>
<?php if ($admin_user->phone_number->Visible) { // phone_number ?>
		<th><span id="elh_admin_user_phone_number" class="admin_user_phone_number"><?php echo $admin_user->phone_number->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($admin_user->_userid->Visible) { // userid ?>
		<td<?php echo $admin_user->_userid->CellAttributes() ?>>
<span id="el<?php echo $admin_user_delete->RowCnt ?>_admin_user__userid" class="admin_user__userid">
...
<?php } ?>
<?php if ($admin_user->username->Visible) { // username ?>
		<td<?php echo $admin_user->username->CellAttributes() ?>>
<span id="el<?php echo $admin_user_delete->RowCnt ?>_admin_user_username" class="admin_user_username">
...
<?php } ?>
<?php if ($admin_user->password->Visible) { // password ?>
		<td<?php echo $admin_user->password->CellAttributes() ?>>
<span id="el<?php echo $admin_user_delete->RowCnt ?>_admin_user_password" class="admin_user_password">
...
<?php } ?>
<?php if ($admin_user->_email->Visible) { // email ?>
		<td<?php echo $admin_user->_email->CellAttributes() ?>>
<span id="el<?php echo $admin_user_delete->RowCnt ?>_admin_user__email" class="admin_user__email">
...
<?php } ?>
<?php if ($admin_user->phone_number->Visible) { // phone_number ?>
		<td<?php echo $admin_user->phone_number->CellAttributes() ?>>
<span id="el<?php echo $admin_user_delete->RowCnt ?>_admin_user_phone_number" class="admin_user_phone_number">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $admin_user_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
