		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "model_galleryview.php")
...
var CurrentForm = fmodel_galleryadd = new ew_Form("fmodel_galleryadd", "add");

// Validate form
fmodel_galleryadd.Validate = function() {
...
fmodel_galleryadd.Lists["x_model_id"] = {"LinkField":"x_model_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_model_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"model"};
fmodel_galleryadd.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmodel_galleryadd.Lists["x_status"].Options = <?php echo json_encode($model_gallery->status->Options()) ?>;
...
<?php if (!$model_gallery_add->IsModal) { ?>
<div class="ewToolbar">
...
?>
<form name="fmodel_galleryadd" id="fmodel_galleryadd" class="<?php echo $model_gallery_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($model_gallery_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $model_gallery_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $model_gallery_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
