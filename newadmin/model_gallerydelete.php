	...
	function DeleteRows() {
		...
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$OldFiles = explode(EW_MULTIPLE_UPLOAD_SEPARATOR, $row['image']);
...
fmodel_gallerydelete.Lists["x_status"].Options = <?php echo json_encode($model_gallery->status->Options()) ?>;
...
<?php if ($model_gallery->gallery_id->Visible) { // gallery_id ?>
		<th><span id="elh_model_gallery_gallery_id" class="model_gallery_gallery_id"><?php echo $model_gallery->gallery_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_gallery->model_id->Visible) { // model_id ?>
		<th><span id="elh_model_gallery_model_id" class="model_gallery_model_id"><?php echo $model_gallery->model_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_gallery->image->Visible) { // image ?>
		<th><span id="elh_model_gallery_image" class="model_gallery_image"><?php echo $model_gallery->image->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_gallery->img_order->Visible) { // img_order ?>
		<th><span id="elh_model_gallery_img_order" class="model_gallery_img_order"><?php echo $model_gallery->img_order->FldCaption() ?></span></th>
<?php } ?>
<?php if ($model_gallery->status->Visible) { // status ?>
		<th><span id="elh_model_gallery_status" class="model_gallery_status"><?php echo $model_gallery->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
