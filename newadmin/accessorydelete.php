...
faccessorydelete.Lists["x_status"].Options = <?php echo json_encode($accessory->status->Options()) ?>;
...
<?php if ($accessory->acs_id->Visible) { // acs_id ?>
		<th><span id="elh_accessory_acs_id" class="accessory_acs_id"><?php echo $accessory->acs_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($accessory->title->Visible) { // title ?>
		<th><span id="elh_accessory_title" class="accessory_title"><?php echo $accessory->title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($accessory->_thumbnail->Visible) { // thumbnail ?>
		<th><span id="elh_accessory__thumbnail" class="accessory__thumbnail"><?php echo $accessory->_thumbnail->FldCaption() ?></span></th>
<?php } ?>
<?php if ($accessory->status->Visible) { // status ?>
		<th><span id="elh_accessory_status" class="accessory_status"><?php echo $accessory->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
