	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["proid"] <> "") {
				...
				$this->proid->setFormValue($_POST["proid"]);
				$this->RecKey["proid"] = $this->proid->FormValue;
			} else {
...
var CurrentForm = fpromotionview = new ew_Form("fpromotionview", "view");
...
<div class="ewToolbar">
<?php if (!$promotion_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $promotion_view->ExportOptions->Render("body") ?>
<?php
	foreach ($promotion_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$promotion_view->IsModal) { ?>
...
?>
<form name="fpromotionview" id="fpromotionview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($promotion_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $promotion_view->Token ?>">
<?php } ?>
...
<?php if ($promotion->proid->Visible) { // proid ?>
	<tr id="r_proid">
		<td><span id="elh_promotion_proid"><?php echo $promotion->proid->FldCaption() ?></span></td>
...
<?php if ($promotion->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_promotion_image"><?php echo $promotion->image->FldCaption() ?></span></td>
...
<?php if ($promotion->pro_title->Visible) { // pro_title ?>
	<tr id="r_pro_title">
		<td><span id="elh_promotion_pro_title"><?php echo $promotion->pro_title->FldCaption() ?></span></td>
...
<?php if ($promotion->pro_des->Visible) { // pro_des ?>
	<tr id="r_pro_des">
		<td><span id="elh_promotion_pro_des"><?php echo $promotion->pro_des->FldCaption() ?></span></td>
		<td data-name="pro_des"<?php echo $promotion->pro_des->CellAttributes() ?>>
...
<?php if ($promotion->pro_date->Visible) { // pro_date ?>
	<tr id="r_pro_date">
		<td><span id="elh_promotion_pro_date"><?php echo $promotion->pro_date->FldCaption() ?></span></td>
...
<?php if ($promotion->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_promotion_status"><?php echo $promotion->status->FldCaption() ?></span></td>
