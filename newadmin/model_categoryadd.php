...
fmodel_categoryadd.ValidateRequired = true;
<?php } else { ?>
fmodel_categoryadd.ValidateRequired = false; 
<?php } ?>
...
fmodel_categoryadd.Lists["x_status"].Options = <?php echo json_encode($model_category->status->Options()) ?>;
...
<?php if ($model_category->category_name->Visible) { // category_name ?>
	<div id="r_category_name" class="form-group">
		<label id="elh_model_category_category_name" for="x_category_name" class="col-sm-2 control-label ewLabel"><?php echo $model_category->category_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $model_category->category_name->CellAttributes() ?>>
...
<?php if ($model_category->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_model_category_status" for="x_status" class="col-sm-2 control-label ewLabel"><?php echo $model_category->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $model_category->status->CellAttributes() ?>>
