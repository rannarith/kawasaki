...
<?php if ($news->_thumbnail->Visible) { // thumbnail ?>
		<th><span id="elh_news__thumbnail" class="news__thumbnail"><?php echo $news->_thumbnail->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news->title->Visible) { // title ?>
		<th><span id="elh_news_title" class="news_title"><?php echo $news->title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news->youtube_url->Visible) { // youtube_url ?>
		<th><span id="elh_news_youtube_url" class="news_youtube_url"><?php echo $news->youtube_url->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($news->status->Visible) { // status ?>
		<th><span id="elh_news_status" class="news_status"><?php echo $news->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
