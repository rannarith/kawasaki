...
<?php if ($news->_thumbnail->Visible) { // thumbnail ?>
	<tr id="r__thumbnail">
		<td><span id="elh_news__thumbnail"><?php echo $news->_thumbnail->FldCaption() ?></span></td>
...
<?php echo $news->_thumbnail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($news->short_des->Visible) { // short_des ?>
	<tr id="r_short_des">
		<td><span id="elh_news_short_des"><?php echo $news->short_des->FldCaption() ?></span></td>
...
<?php if ($news->long_des->Visible) { // long_des ?>
	<tr id="r_long_des">
		<td><span id="elh_news_long_des"><?php echo $news->long_des->FldCaption() ?></span></td>
...
<?php if ($news->youtube_url->Visible) { // youtube_url ?>
	<tr id="r_youtube_url">
		<td><span id="elh_news_youtube_url"><?php echo $news->youtube_url->FldCaption() ?></span></td>
