...
<?php if ($promotion->proid->Visible) { // proid ?>
		<th><span id="elh_promotion_proid" class="promotion_proid"><?php echo $promotion->proid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($promotion->image->Visible) { // image ?>
		<th><span id="elh_promotion_image" class="promotion_image"><?php echo $promotion->image->FldCaption() ?></span></th>
<?php } ?>
<?php if ($promotion->pro_title->Visible) { // pro_title ?>
		<th><span id="elh_promotion_pro_title" class="promotion_pro_title"><?php echo $promotion->pro_title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($promotion->pro_date->Visible) { // pro_date ?>
		<th><span id="elh_promotion_pro_date" class="promotion_pro_date"><?php echo $promotion->pro_date->FldCaption() ?></span></th>
<?php } ?>
<?php if ($promotion->status->Visible) { // status ?>
		<th><span id="elh_promotion_status" class="promotion_status"><?php echo $promotion->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
