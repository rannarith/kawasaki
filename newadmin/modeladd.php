...
fmodeladd.Lists["x_status"].Options = <?php echo json_encode($model->status->Options()) ?>;
...
<script type="text/javascript">
ew_CreateEditor("fmodeladd", "x_description", 55, 6, <?php echo ($model->description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
